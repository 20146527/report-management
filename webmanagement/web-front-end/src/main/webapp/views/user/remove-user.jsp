...
<c:url var="deleteUserUrl" value="/ajax-user-edit.html">
        ...
        <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h3>Xác nhận xóa người dùng: "${item.pojo.fullName}" ?</h3>
                    </div>
                    <form action="${deleteUserUrl}" method="post" id="removeUserForm">
