...
<c:url var="editReportUrl" value="/report-list.html">
                ...
                <div class="card-body">
                    ...
                    <form action="${editReportUrl}" method="post" id="editReportForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-11">
                                    <input type="text" id="tag" name="pojo.tag" value="${item.pojo.tag}"
                        ...
                        <input type="hidden" name="pojo.reportId" value="${item.pojo.reportId}">
                        <input type="hidden" name="sessionId" value="${item.pojo.sessionDto.sessionId}">
                        <input type="hidden" name="templateId" value="${item.pojo.templateDto.templateId}">
                        <input type="hidden" name="recordId" value="${item.pojo.recordDto.recordId}">
                        <input type="hidden" name="stenoId" value="${item.pojo.stenographyDto.stenoId}">
...
<script>
    document.title = "Chỉnh sửa biên bản";
