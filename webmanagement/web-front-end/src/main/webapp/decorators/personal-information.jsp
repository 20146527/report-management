    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Infomation</a></li>
...
<!-- End Wrapper -->
<!-- All Jquery -->
<script src="<c:url value='/template/js/lib/jquery/jquery.min.js'/>"></script>
...
<script src="<c:url value='/template/js/avatar.js'/>"></script>
<style>
    .alignleft:hover{
        color: #0d71bb;
