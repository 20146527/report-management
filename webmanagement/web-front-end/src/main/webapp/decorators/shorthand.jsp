...
<head>
    ...
    <link href="<c:url value='/template/css/lib/jquery-filer/themes/jquery.filer-dragdropbox-theme.css'/>"
          rel="stylesheet">
    ...
    <link rel="stylesheet" href="<c:url value="../template/css/lib/jquery/jquery-ui.css"/>"/>
...
<body class="fix-header fix-sidebar" onkeydown='fnActiveOverwriteByKey()'>
...
<script src="<c:url value="/template/js/lib/editor/editor.js"/>"></script>
<script src="<c:url value="/template/js/steno/typing/overwriteMode.js"/>"></script>
<script src="<c:url value="/template/js/steno/typing/undoRedo.js"/>"></script>
