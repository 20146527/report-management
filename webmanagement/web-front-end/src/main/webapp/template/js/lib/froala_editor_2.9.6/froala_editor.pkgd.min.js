...
!function (n) {
    ...
    s.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, s.MODULES = {}, s.PLUGINS = {}, s.VERSION = "2.9.6", s.INSTANCES = [], s.OPTS_MAPPING = {}, s.SHARED = {}, s.ID = 0, s.prototype._init = function () {
        ...
        if ("string" == typeof i) {
            ...
            return this.each(function () {
                var e, t, n = be(this).data("froala.editor");
                if (!n) return console.warn("Editor should be initialized before calling the " + i + " method.");
                if (0 < i.indexOf(".") && n[i.split(".")[0]] ? (n[i.split(".")[0]] && (e = n[i.split(".")[0]]), t = i.split(".")[1]) : (e = n, t = i.split(".")[0]), !e[t]) return be.error("Method " + i + " does not exist in Froala Editor.");
    ...
    be.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", be.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", be.FE.LinkRegExTLD = "((" + be.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", be.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExWWW = "(www\\." + be.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", be.FE.LinkRegEx = "(" + be.FE.LinkRegExTLD + "|" + be.FE.LinkRegExHTTP + "|" + be.FE.LinkRegExWWW + "|" + be.FE.LinkRegExAuth + ")" + be.FE.LinkRegExEnd, be.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], be.FE.MAIL_REGEX = /.+@.+\..+/i, be.FE.MODULES.helpers = function (a) {
    ...
    }, be.FE.MODULES.events = function (l) {
        var e, o = {};
        ...
        function n(e) {
            ...
            if (l.selection.info(l.el).atStart && l.selection.isCollapsed() && null != l.html.defaultTag()) {
                ...
                if (r && !l.node.blockParent(r)) {
                    ...
                    i && (be(i).prepend(be.FE.MARKERS), l.selection.restore())
                } else r && be(r).remove()
            }
        }
        ...
        function u(e, t, n) {
            if (!l.edit.isDisabled() || n) {
                ...
                return !1 !== (i = l.$oel.triggerHandler("froalaEditor." + e, be.merge([l], t || []))) && i
            }
        }
        ...
        return {
            _init: function () {
                l.shared.$_events = l.shared.$_events || [], l.shared._events = {}, l.helpers.isMobile() ? (l._mousedown = "touchstart", l._mouseup = "touchend", l._move = "touchmove", l._mousemove = "touchmove") : (l._mousedown = "mousedown", l._mouseup = "mouseup", l._move = "", l._mousemove = "mousemove"), t(l.$el, "click mouseup mousedown touchstart touchend dragenter dragover dragleave dragend drop dragstart", function (e) {
                    ...
                    for (var e = 0; e < be.FE.INSTANCES.length; e++) be.FE.INSTANCES[e] != l && be.FE.INSTANCES[e].popups && be.FE.INSTANCES[e].popups.areVisible() && be.FE.INSTANCES[e].$el.find(".fr-marker").remove()
            ...
            }, disableBlur: s, enableBlur: a, blurActive: i, focus: n, chainTrigger: function (e, t, n) {
                if (!l.edit.isDisabled() || n) {
                    var r, i;
                    if (0 !== e.indexOf("shared.")) r = o[e]; else {
                        if (0 < l.shared.count) return !1;
                    ...
                    return void 0 !== (i = l.$oel.triggerHandler("froalaEditor." + e, be.merge([l], [t]))) && (t = i), t
                }
            }, $on: f, $off: function () {
        ...
        function l() {
            ...
            try {
                ...
                if (d.core.isEmpty() && t.textContent !== be("<span>").html(be.FE.INVISIBLE_SPACE).text()) return d.selection.setAtStart(d.el), d.$el.find(".fr-marker:first").replaceWith('<span class="fr-single-marker" style="display: none; line-height: 0;">' + be.FE.INVISIBLE_SPACE + "</span>"), d.$el.find(".fr-marker").remove(), d.$el.find(".fr-single-marker").removeClass("fr-single-marker").addClass("fr-marker").get(0);
            ...
            place: function (e, t, n) {
                ...
                try {
                    ...
                    if (!1 === t && !e.collapsed) {
                        ...
                        (r.parentNode && 0 <= ["TD", "TH"].indexOf(r.parentNode.tagName) || !r.previousSibling && d.node.isBlock(r.parentElement)) && r.parentNode.previousSibling && !r.previousSibling && be(r.parentNode.previousSibling).append(r)
                    }
        ...
        function _(e, t) {
            ...
            for (var r = T.node.contents(e), i = 0; i < r.length; i++) r[i].nodeType != Node.ELEMENT_NODE ? be(r[i]).remove() : (_(r[i], 0 === i), 0 === i && (t = !1));
        ...
        function a(e, t) {
            ...
            for (r.setAttribute("id", "fr-sel-markers"), r.innerHTML = be.FE.MARKERS; e.parentNode && T.opts.htmlAllowedEmptyTags && 0 <= T.opts.htmlAllowedEmptyTags.indexOf(e.tagName.toLowerCase());) e = e.parentNode;
            e.appendChild(r);
        ...
        return {
            text: s, get: A, ranges: c, clear: C, element: function () {
                ...
                return T.el
            }, save: S, restore: R, isCollapsed: L, isFull: function () {
                if (L()) return !1;
                T.selection.save();
        ...
        htmlUntouched: !1,
        fullPage: !1
    }), be.FE.HTML5Map = {B: "STRONG", I: "EM", STRIKE: "S"}, be.FE.MODULES.clean = function (f) {
        var p, u, h, g;
        ...
        function c(e, t, n) {
            ...
            var a = function (e, t, n) {
                if (f.opts.fullPage) {
                    var r = f.html.extractDoctype(n), i = l(f.html.extractNodeAttrs(n, "html"));
        ...
        function E(e) {
            ...
            !function (e) {
                ...
                if (e.nodeType == Node.ELEMENT_NODE && be.FE.HTML5Map[e.tagName] && "" === f.node.attributes(e)) {
                ...
                if (f.opts.htmlAllowComments || e.nodeType != Node.COMMENT_NODE) if (e.tagName && e.tagName.match(u)) e.parentNode.removeChild(e); else if (e.tagName && !e.tagName.match(p)) {
                    ...
                    if (a) for (var o = a.length - 1; 0 <= o; o--) {
                        var s = a[o], l = s.nodeName.match(h), d = null;
        ...
        return {
            _init: function () {
                f.opts.fullPage && be.merge(f.opts.htmlAllowedTags, ["head", "title", "style", "link", "base", "body", "html", "meta"])
            }, html: function (e, t, n, r) {
                void 0 === t && (t = []), void 0 === n && (n = []), void 0 === r && (r = !1);
                var i, a = be.merge([], f.opts.htmlAllowedTags);
                for (i = 0; i < t.length; i++) 0 <= a.indexOf(t[i]) && a.splice(a.indexOf(t[i]), 1);
                var o = be.merge([], f.opts.htmlAllowedAttrs);
                ...
                var e = f.el.querySelectorAll(Object.keys(be.FE.HTML5Map).join(","));
                if (e.length) {
                    var t = !1;
                    f.el.querySelector(".fr-marker") || (f.selection.save(), t = !0);
                    for (var n = 0; n < e.length; n++) "" === f.node.attributes(e[n]) && be(e[n]).replaceWith("<" + be.FE.HTML5Map[e[n].tagName] + ">" + e[n].innerHTML + "</" + be.FE.HTML5Map[e[n].tagName] + ">");
                ...
                !function () {
                    ...
                    for (var e = f.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++) for (var n = f.node.contents(e[t]), r = null, i = n.length - 1; 0 <= i; i--) "LI" != n[i].tagName && "UL" != n[i].tagName && "OL" != n[i].tagName ? (r || (r = be("<li>")).insertBefore(n[i]), r.prepend(n[i])) : r = null
                }(), function () {
                    var e, t, n;
                    do {
                        t = !1;
                    ...
                    for (var e = f.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
                        var n = e[t];
                        if (f.node.isFirstSibling(n)) be(n).before("<br/>"); else if (n.previousSibling && "BR" == n.previousSibling.tagName) {
                    ...
                    for (var e = f.el.querySelectorAll("li:empty"), t = 0; t < e.length; t++) be(e[t]).remove()
                }()
        ...
        function r(e, t) {
            ...
            if (!l.html.isPreformatted(a)) {
                ...
                for (var o = "", s = 0; s < i.length; s++) 32 != i.charCodeAt(s) || 0 !== s && 32 != o.charCodeAt(s - 1) || n && r && l.node.isVoid(n) || n && r && l.node.isVoid(r) ? o += i[s] : o += be.FE.UNICODE_NBSP;
    ...
    }), be.FE.MODULES.html = function (w) {
        function c() {
            return w.opts.enter == be.FE.ENTER_P ? "p" : w.opts.enter == be.FE.ENTER_DIV ? "div" : w.opts.enter == be.FE.ENTER_BR ? null : void 0
        }
        ...
        function a(e) {
            ...
            var l = p();
            for (l += "," + be.FE.VOID_ELEMENTS.join(","), l += ", .fr-inner", l += "," + w.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)", t = r.length - 1; 0 <= t; t--) if (!(r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, "").length || 0 < r[t].querySelectorAll(l).length)) {
                for (var d = w.node.contents(r[t]), c = !1, f = 0; f < d.length; f++) if (d[f].nodeType != Node.COMMENT_NODE && d[f].textContent && 0 < d[f].textContent.replace(/\u200B|\n/g, "").length) {
                    c = !0;
                    break
                }
                c || n.push(r[t])
        ...
        function e(e) {
            ...
            r = be.merge(r, w.opts.htmlAllowedEmptyTags), r = void 0 === e ? be.merge(r, be.FE.BLOCK_TAGS) : be.merge(r, be.FE.NO_DELETE_TAGS), t = w.el.querySelectorAll("*:empty:not(" + r.join("):not(") + "):not(.fr-marker)");
            do {
                n = !1;
        ...
        function o(e, t) {
            ...
            if (t && (n = "div"), n) {
                for (var r = w.doc.createDocumentFragment(), i = null, a = !1, o = e.firstChild, s = !1; o;) {
                    var l = o.nextSibling;
                    if (o.nodeType == Node.ELEMENT_NODE && (w.node.isBlock(o) || 0 <= w.opts.htmlDoNotWrapTags.indexOf(o.tagName.toLowerCase()) && !w.node.hasClass(o, "fr-marker"))) i = null, r.appendChild(o.cloneNode(!0)); else if (o.nodeType != Node.ELEMENT_NODE && o.nodeType != Node.TEXT_NODE) i = null, r.appendChild(o.cloneNode(!0)); else if ("BR" == o.tagName) null == i ? (i = w.doc.createElement(n), s = !0, t && (i.setAttribute("class", "fr-temp-div"), i.setAttribute("data-empty", !0)), i.appendChild(o.cloneNode(!0)), r.appendChild(i)) : !1 === a && (i.appendChild(w.doc.createElement("br")), t && (i.setAttribute("class", "fr-temp-div"), i.setAttribute("data-empty", !0))), i = null; else {
                        var d = o.textContent;
        ...
        function d(e) {
            ...
            if (t && (w.node.isBlock(t) || w.node.isElement(t)) && ["TD", "TH"].indexOf(t.tagName) < 0) {
                ...
                if (r) return !1;
                n && t && "BR" != n.tagName && !w.node.isBlock(n) && !r && 0 < t.textContent.replace(/\u200B/g, "").length && 0 < n.textContent.length && !w.node.hasClass(n, "fr-marker") && (w.el == t && !r && w.opts.enter == be.FE.ENTER_BR && w.browser.msie || e.parentNode.removeChild(e))
        ...
        return {
            defaultTag: c, isPreformatted: s, emptyBlocks: a, emptyBlockTagsQuery: function () {
                ...
                var t = a(e);
                w.node.isEmpty(w.el) && w.opts.enter === be.FE.ENTER_BR && t.push(w.el);
                for (var n = 0; n < t.length; n++) {
                    var r = t[n];
                    "false" === r.getAttribute("contenteditable") || r.querySelector(w.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || w.node.isVoid(r) || "TABLE" != r.tagName && "TBODY" != r.tagName && "TR" != r.tagName && "UL" != r.tagName && "OL" != r.tagName && r.appendChild(w.doc.createElement("br"))
                }
                if (w.browser.msie && w.opts.enter == be.FE.ENTER_BR) {
                ...
                var r, i, a = [], o = {}, s = [], l = w.el.querySelectorAll("input, textarea");
                ...
                if (w.node.isEmpty(w.el)) w.opts.fullPage && (n = O(w.iframe_document), n += "<html" + w.node.attributes(w.$html.get(0)) + ">" + w.$html.find("head").get(0).outerHTML + "<body></body></html>"); else if (void 0 === e && (e = !1), w.opts.fullPage) {
                    n = O(w.iframe_document), w.$el.removeClass("fr-view");
                    var y = w.opts.heightMin, L = w.opts.height, _ = w.opts.heightMax;
                ...
                if (!w.opts.useClasses && !t) for (r = 0; r < a.length; r++) a[r].getAttribute("fr-original-class") && (a[r].setAttribute("class", a[r].getAttribute("fr-original-class")), a[r].removeAttribute("fr-original-class")), null != a[r].getAttribute("fr-original-style") && void 0 !== a[r].getAttribute("fr-original-style") ? (0 !== a[r].getAttribute("fr-original-style").length ? a[r].setAttribute("style", a[r].getAttribute("fr-original-style")) : a[r].removeAttribute("style"), a[r].removeAttribute("fr-original-style")) : a[r].removeAttribute("style");
                ...
                var x = w.events.chainTrigger("html.get", n);
                ...
                var e, t, n = function (e, t) {
                    for (; t && (t.nodeType == Node.TEXT_NODE || !w.node.isBlock(t)) && !w.node.isElement(t) && !w.node.hasClass(t, "fr-inner");) t && t.nodeType != Node.TEXT_NODE && be(e).wrapInner(w.node.openTagString(t) + w.node.closeTagString(t)), t = t.parentNode;
                ...
                var r, i, a;
                if (w.selection.isCollapsed() || w.selection.remove(), r = t ? e : w.clean.html(e), e.indexOf('class="fr-marker"') < 0 && (i = r, (a = w.doc.createElement("div")).innerHTML = i, w.selection.setAtEnd(a, !0), r = a.innerHTML), w.node.isEmpty(w.el) && !w.opts.keepFormatOnDelete && f(r)) w.el.innerHTML = r; else {
                    var o = w.markers.insert();
                    if (o) {
                        w.node.isLastSibling(o) && be(o).parent().hasClass("fr-deletable") && be(o).insertAfter(be(o).parent());
                        ...
                        if ((f(r) || n) && (w.node.deepestParent(o) || s && "LI" == s.tagName)) {
                            if (s && "LI" == s.tagName && (r = function (e) {
                                ...
                                for (var n = t.querySelectorAll(":scope > " + w.html.defaultTag()), r = n.length - 1; 0 <= r; r--) {
                                    var i = n[r];
                                    w.node.isBlock(i.previousSibling) || (i.previousSibling && !w.node.isEmpty(i) && be("<br>").insertAfter(i.previousSibling), i.outerHTML = i.innerHTML)
                                }
                                return t.innerHTML
                ...
                w.$el.find("div.fr-temp-div").each(function () {
                    this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && be(this).before("<br>"), be(this).attr("data-empty") || !this.nextSibling || w.node.isBlock(this.nextSibling) && !be(this.nextSibling).hasClass("fr-temp-div") ? be(this).replaceWith(be(this).html()) : be(this).replaceWith(be(this).html() + "<br>")
    ...
    }, be.extend(be.FE.DEFAULTS, {placeholderText: "Type something"}), be.FE.MODULES.placeholder = function (f) {
        function e() {
            f.$placeholder || (f.$placeholder = be('<span class="fr-placeholder"></span>'), f.$wp.append(f.$placeholder));
            var e = f.opts.iframe ? f.$iframe.prev().outerHeight(!0) : f.$el.prev().outerHeight(!0), t = 0, n = 0,
                r = 0, i = 0, a = 0, o = 0, s = f.node.contents(f.el), l = be(f.selection.element()).css("text-align");
        ...
        function t() {
            if (d.$box.addClass("fr-box" + (d.opts.editorClass ? " " + d.opts.editorClass : "")), d.$box.attr("role", "application"), d.$wp.addClass("fr-wrapper"), d.opts.documentReady && d.$box.addClass("fr-document"), d.opts.iframe || d.$el.addClass("fr-element fr-view"), d.opts.iframe) {
                ...
                for (var e = 0; e < d.o_doc.styleSheets.length; e++) {
                    ...
                    if (t) for (var n = 0, r = t.length; n < r; n++) !t[n].selectorText || 0 !== t[n].selectorText.indexOf(".fr-view") && 0 !== t[n].selectorText.indexOf(".fr-element") || 0 < t[n].style.cssText.length && (0 === t[n].selectorText.indexOf(".fr-view") ? c.push({
        ...
        return {
            _init: function () {
                if (be.FE.INSTANCES.push(d), d.drag_support = {
                ...
                if (d.opts.iframe) {
                    ...
                    for (var t = be('<style data-fr-style="true">' + e + "</style>").appendTo(d.$head)[0].sheet, n = 0; n < c.length; n++) for (var r = t.insertRule(c[n].selector + "{}", t.cssRules.length), i = 0; i < c[n].style.length; i++) {
                        var a = c[n].style[i], o = c[n].style[a];
                        d.browser.safari && "content" === a && (o = '"' + o + '"'), t.cssRules[r].style[a] = o
                    }
                    for (var s = 0; s < d.opts.iframeStyleFiles.length; s++) {
                        var l = be('<link data-fr-style="true" rel="stylesheet" href="' + d.opts.iframeStyleFiles[s] + '">');
        ...
        return {
            _startEnter: function (e) {
                ...
                for (var t = m(e), n = "", r = e, i = "", a = "", o = !1; r != t;) {
                    var s = "A" == (r = r.parentNode).tagName && g.cursor.isAtEnd(e, r) ? "fr-to-remove" : "";
                    o || r == t || g.node.isBlock(r) || (o = !0, i += be.FE.INVISIBLE_SPACE), i = g.node.openTagString(be(r).clone().addClass(s).get(0)) + i, a = g.node.closeTagString(r) + a
                }
                n = a + n + i + be.FE.MARKERS + (g.opts.keepFormatOnDelete ? be.FE.INVISIBLE_SPACE : ""), be(e).replaceWith('<span id="fr-break"></span>');
                var l = g.node.openTagString(t) + be(t).html() + g.node.closeTagString(t);
                l = l.replace(/<span id="fr-break"><\/span>/g, n), be(t).replaceWith(l)
        ...
        function c(e) {
            ...
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType == Node.TEXT_NODE) {
                    ...
                    n.textContent = r.substring(0, i - d(r)), u.opts.htmlUntouched && !e.nextSibling && n.textContent.length && " " === n.textContent[n.textContent.length - 1] && (n.textContent = n.textContent.substring(0, n.textContent.length - 1) + be.FE.UNICODE_NBSP);
                    var a = r.length != n.textContent.length;
                    if (0 === n.textContent.length) if (a && u.opts.keepFormatOnDelete) be(n).after(be.FE.INVISIBLE_SPACE + be.FE.MARKERS); else if (0 !== r.length && u.node.isBlock(n.parentNode)) be(n).after(be.FE.MARKERS); else if ((2 != n.parentNode.childNodes.length || n.parentNode != e.parentNode) && 1 != n.parentNode.childNodes.length || u.node.isBlock(n.parentNode) || u.node.isElement(n.parentNode) || !u.node.isDeletable(n.parentNode)) {
                        for (; !u.node.isElement(n.parentNode) && u.node.isEmpty(n.parentNode) && be.FE.NO_DELETE_TAGS.indexOf(n.parentNode.tagName) < 0;) {
                            var o = n;
        ...
        function n(e) {
            ...
            } else if (be.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) be(e).replaceWith(be.FE.MARKERS), be(n).remove(); else if (u.node.isList(n)) e.previousSibling ? (be(n).find("li:first").prepend(e), u.cursorLists._backspace(e)) : (be(n).find("li:first").prepend(be.FE.MARKERS), be(e).remove()); else if ((t = u.node.contents(n)) && t.length && "BR" == t[0].tagName && be(t[0]).remove(), t && "BLOCKQUOTE" == n.tagName) {
                var r = t[0];
            ...
            if (null == i) (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? be(e).replaceWith("<" + r + ">" + be.FE.MARKERS + "<br></" + r + ">") : !e.previousSibling || be(e.previousSibling).is("br") || e.nextSibling ? be(e).replaceWith("<br>" + be.FE.MARKERS) : be(e).replaceWith("<br>" + be.FE.MARKERS + "<br>"); else {
                ...
                do {
                    if (a = a.parentNode, !t || a != i || t && !u.node.isBlock(i)) if (l += u.node.closeTagString(a), a == i && u.node.isBlock(i)) d = c + d; else {
                        var p = ("A" == a.tagName || be(a).hasClass("fa")) && g(e, a) ? "fr-to-remove" : "";
            ...
            if (null == r) u.html.defaultTag() && e.parentNode === u.el ? be(e).replaceWith("<" + u.html.defaultTag() + ">" + be.FE.MARKERS + "<br></" + u.html.defaultTag() + ">") : (e.nextSibling && !u.node.isBlock(e.nextSibling) || be(e).after("<br>"), be(e).replaceWith("<br>" + be.FE.MARKERS)); else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName) be(e).replaceWith("<" + u.html.defaultTag() + ">" + be.FE.MARKERS + "<br></" + u.html.defaultTag() + ">"); else {
                ...
                do {
                    ...
                    if (i = i.parentNode, "BLOCKQUOTE" == r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && 0 < be(l).find(e).length && be(l).after(e), "BLOCKQUOTE" != r.tagName || !g(e, i) && !h(e, i)) if (!t || i != r || t && !u.node.isBlock(r)) {
                        ...
                        var d = "A" == i.tagName && g(e, i) || be(i).hasClass("fa") ? "fr-to-remove" : "";
        ...
        return {
            enter: function (t) {
                ...
                for (var r = n.parentNode; r && !u.node.isElement(r);) {
                    if ("false" === r.getAttribute("contenteditable")) return be(n).replaceWith(be.FE.MARKERS), u.selection.restore(), !1;
                    if ("true" === r.getAttribute("contenteditable")) break;
                    r = r.parentNode
                }
                u.el.normalize();
                var i = !1;
                0 < be(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (i = !0), be(n).parentsUntil(u.$el, "TD, TH").length && (i = !1), a(n) ? !s(n) || t || i ? p(n, t, i) : u.cursorLists._endEnter(n) : o(n) ? !s(n) || t || i ? function e(t, n, r) {
                    ...
                    if (null == a) (i = u.html.defaultTag()) && u.node.isElement(t.parentNode) ? be(t).replaceWith("<" + i + ">" + be.FE.MARKERS + "<br></" + i + ">") : be(t).replaceWith("<br>" + be.FE.MARKERS); else {
                        if (u.node.isBlock(a)) if ("PRE" == a.tagName && (n = !0), n) be(t).remove(), be(a).prepend("<br>" + be.FE.MARKERS); else {
                            ...
                            if (t.nextSibling && "IMG" == t.nextSibling.tagName || t.nextSibling && t.nextSibling.nextElementSibling && "IMG" == t.nextSibling.nextElementSibling) be(t).replaceWith("<" + u.html.defaultTag() + ">" + be.FE.MARKERS + "<br></" + u.html.defaultTag() + ">"); else if (u.opts.keepFormatOnDelete) {
                ...
                return a(t) ? s(t) && h(t, be(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : e = c(t) : o(t) ? s(t) && h(t, be(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : function (e) {
                    ...
                    if (null !== n) {
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n)) if (o && be.FE.NO_DELETE_TAGS.indexOf(o.tagName) < 0) {
                            if (u.node.isDeletable(o)) be(o).remove(), be(e).replaceWith(be.FE.MARKERS); else if (u.node.isEditable(o)) if (u.node.isBlock(o)) if (u.node.isEmpty(o) && !u.node.isList(o)) be(o).remove(), be(e).after(u.opts.keepFormatOnDelete ? be.FE.INVISIBLE_SPACE : ""); else {
                        ...
                        } else o || (n && "BLOCKQUOTE" === n.tagName && 0 === be(n).text().replace(/\u200B/g, "").length ? be(n).remove() : u.node.isEmpty(n) && n.parentNode && u.node.isEditable(n.parentNode) && n.parentNode != u.el && be(n.parentNode).remove())
                    }
        ...
        function T(e) {
            var t = l.el.childNodes, n = l.html.defaultTag(), r = l.node.blockParent(l.selection.blocks()[0]);
            return !l.node.isEditable(e.target) || r && "false" == be(r).attr("contenteditable") ? l.toolbar.disable() : l.toolbar.enable(), !(!e.target || e.target === l.el) || (0 === t.length || void (t[0].offsetHeight + t[0].offsetTop <= e.offsetY ? b(t[t.length - 1]) && (n ? l.$el.append("<" + n + ">" + be.FE.MARKERS + "<br></" + n + ">") : l.$el.append(be.FE.MARKERS + "<br>"), l.selection.restore(), s()) : e.offsetY <= 10 && b(t[0]) && (n ? l.$el.prepend("<" + n + ">" + be.FE.MARKERS + "<br></" + n + ">") : l.$el.prepend(be.FE.MARKERS + "<br>"), l.selection.restore(), s())))
        }
        ...
        function m(e, t, n) {
            if (e) {
                ...
                if (e) {
                    if (g.node.isBlock(e) && "HR" !== e.tagName) return g.node.hasClass(e.firstChild, "fr-marker") ? m(e.firstChild.nextSibling, t, n) : m(e.firstChild, t, n), !1;
                    ...
                    if (i) be(i).find(".fr-marker").length || "UL" == i.tagName || "OL" == i.tagName ? m(i.firstChild, t, n) : g.browser.mozilla && g.node.hasClass(i, "fr-marker") && i.parentNode.nextSibling && m(i.parentNode.nextSibling.nextSibling, t, n); else {
            ...
            !function e(t, n, r, i) {
                for (var a = g.node.contents(t.get(0)), o = 0; o < a.length; o++) {
                    ...
                    if (g.node.hasClass(s, "fr-marker")) n = (n + 1) % 2; else if (n) if (0 < be(s).find(".fr-marker").length) n = e(be(s), n, r, i); else {
                        for (var l = be(s).find(r || "*:not(br)"), d = l.length - 1; 0 <= d; d--) {
                            var c = l[d];
        ...
        function E(e, t, n) {
            ...
            if ((o = o.not(s)).length) {
                ...
                be(o.get(0)).replaceWith(h.replace(/<span id="fr-break"><\/span>/g, function () {
                    return u
                }))
            }
        }
        ...
        function n(e) {
            ...
            for (var t = o.selection.blocks(), n = 0; n < t.length; n++) if ("LI" != t[n].tagName || "LI" != t[n].parentNode.tagName) {
                var r = be(t[n]);
                "LI" != t[n].tagName && "LI" == t[n].parentNode.tagName && (r = be(t[n].parentNode));
            ...
            _init: function () {
                ...
                for (var n, r, i, a = !(p.ul = !0), o = 0, s = 0; s < e.length; s++) {
                    ...
                    if (d === E(g(E("mcVRDoB1BGILD7YFe1BTXBA7B6=="))) || 0 <= d.indexOf(h, d.length - h.length) || C(h)) {
                        if (!((null === (n = l[1]) || new Date(n) < new Date(E("fA4B3E3C1I3H2C6C6C3E4=="))) && 0 < (h || "").length) || C(h)) {
                            p.ul = !1;
                            break
                        }
    ...
    }), be.FE.MODULES.paste = function (R) {
        var y, o, i, L;

        function n(e, t) {
            try {
                R.win.localStorage.setItem("fr-copied-html", e), R.win.localStorage.setItem("fr-copied-text", t)
            } catch (n) {
            }
        }

        function e(e) {
            var t = R.html.getSelected();
            n(t, be("<div>").html(t).text()), "cut" == e.type && (R.undo.saveStep(), setTimeout(function () {
                R.selection.save(), R.html.wrap(), R.selection.restore(), R.events.focus(), R.undo.saveStep()
            }, 0))
        }
        ...
        function t(e) {
            if (R.edit.isDisabled()) return !1;
            if (a) return !1;
            if (e.originalEvent && (e = e.originalEvent), !1 === R.events.trigger("paste.before", [e])) return e.preventDefault(), !1;
            if (R.$win.scrollTop(), e && e.clipboardData && e.clipboardData.getData) {
                var t = "", n = e.clipboardData.types;
                if (R.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += n[r] + ";"; else t = n;
                if (y = "", /text\/rtf/.test(t) && (o = e.clipboardData.getData("text/rtf")), /text\/html/.test(t) && !R.browser.safari ? y = e.clipboardData.getData("text/html") : /text\/rtf/.test(t) && R.browser.safari ? y = o : /public.rtf/.test(t) && R.browser.safari && (y = e.clipboardData.getData("text/rtf")), "" !== y) return s(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1;
                y = null
            }
            return function () {
                R.selection.save(), R.events.disableBlur(), y = null, i ? (i.html(""), R.browser.edge && R.opts.iframe && R.$el.append(i)) : (i = be('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>'), R.browser.webkit || R.browser.mozilla ? (i.css("top", R.$sc.scrollTop()), R.$el.after(i)) : R.browser.edge && R.opts.iframe ? R.$el.append(i) : R.$box.after(i), R.events.on("destroy", function () {
                    i.remove()
                }));
                var e;
                R.helpers.isIOS() && R.$sc && (e = R.$sc.scrollTop());
                R.opts.iframe && R.$el.attr("contenteditable", "false");
                i.focus(), R.helpers.isIOS() && R.$sc && R.$sc.scrollTop(e);
                R.win.setTimeout(s, 1)
            }(), !1
        }
        ...
        function r(e) {
            if (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                if (R.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += n[r] + ";"; else t = n;
                if (y = "", /text\/rtf/.test(t) && (o = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? y = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && R.browser.safari ? y = o : /text\/plain/.test(t) && !this.browser.mozilla && (y = R.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== y) {
                    R.keys.forceUndo(), L = R.snapshot.get(), R.selection.save(), R.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-helper");
                    var i = R.markers.insertAtPoint(e);
                    if (R.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"), R.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"), R.selection.restore(), R.selection.remove(), R.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"), !1 !== i) {
                        var a = R.el.querySelector(".fr-marker");
                        return be(a).replaceWith(be.FE.MARKERS), R.selection.restore(), s(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1
                    }
                } else y = null
            }
        }
        ...
        function s() {
            R.opts.iframe && R.$el.attr("contenteditable", "true"), R.browser.edge && R.opts.iframe && R.$box.after(i), L || (R.keys.forceUndo(), L = R.snapshot.get()), y || (y = i.get(0).innerHTML, R.selection.restore(), R.events.enableBlur());
            var e = y.match(/(class=\"?Mso|class=\'?Mso|class="?Xl|class='?Xl|class=Xl|style=\"[^\"]*\bmso\-|style=\'[^\']*\bmso\-|w:WordDocument)/gi),
                t = R.events.chainTrigger("paste.beforeCleanup", y);
            t && "string" == typeof t && (y = t), (!e || e && !1 !== R.events.trigger("paste.wordPaste", [y])) && l(y, e)
        }
        ...
        function l(r, e, t) {
            ...
            var c = !1, f = !1;
            if (!e) if (c = function (e) {
                var t = null;
                try {
                    t = R.win.localStorage.getItem("fr-copied-text")
                } catch (n) {
                }
                ...
                var e = null;
                try {
                    e = R.win.localStorage.getItem("fr-dragged-content-text")
                } catch (t) {
                }
                return !(!e || be("<div>").html(y).text().replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") != e.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, ""))
            }(), c && (r = R.win.localStorage.getItem("fr-copied-html")), f && (c = !0, r = R.win.localStorage.getItem("fr-dragged-content-html")), c) r = R.clean.html(r, R.opts.pasteDeniedTags, R.opts.pasteDeniedAttrs); else {
                var p = R.opts.htmlAllowedStyleProps;
                R.opts.htmlAllowedStyleProps = R.opts.pasteAllowedStyleProps, R.opts.htmlAllowComments = !1, r = (r = (r = r.replace(/<span class="Apple-tab-span">\s*<\/span>/g, _(R.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function (e, t) {
                    return _(t.length * (R.opts.tabSpaces || 4))
                })).replace(/\t/g, _(R.opts.tabSpaces || 4)), r = R.clean.html(r, R.opts.pasteDeniedTags, R.opts.pasteDeniedAttrs), R.opts.htmlAllowedStyleProps = p, R.opts.htmlAllowComments = !0, r = (r = (r = x(r)).replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, "")
            }
            !e || R.wordPaste && t || (0 === (r = r.replace(/^\n*/g, "").replace(/^ /g, "")).indexOf("<colgroup>") && (r = "<table>" + r + "</table>"), r = x(r = function (e) {
                var t;
                ...
                e = (e = e.replace(/<lilevel([^1])([^>]*)>/gi, '<li data-indent="true"$2>')).replace(/<lilevel1([^>]*)>/gi, "<li$1>"), e = (e = (e = R.clean.html(e, R.opts.pasteDeniedTags, R.opts.pasteDeniedAttrs)).replace(/<a>(.[^<]+)<\/a>/gi, "$1")).replace(/<br> */g, "<br>");
                var a = R.o_doc.createElement("div");
                a.innerHTML = e;
                ...
                return R.html.cleanBlankSpaces(a), e = a.innerHTML
            }(r))), R.opts.pastePlain && !f && (r = function (e) {
                var t, n = null, r = R.doc.createElement("div");
                r.innerHTML = e;
                var i = r.querySelectorAll("p, div, h1, h2, h3, h4, h5, h6, pre, blockquote");
                for (t = 0; t < i.length; t++) (n = i[t]).outerHTML = "<" + (R.html.defaultTag() || "DIV") + ">" + n.innerHTML + "</" + (R.html.defaultTag() || "DIV") + ">";
                ...
                var a = function (e) {
                    for (var t = R.node.contents(e), n = 0; n < t.length; n++) t[n].nodeType != Node.TEXT_NODE && t[n].nodeType != Node.ELEMENT_NODE ? t[n].parentNode.removeChild(t[n]) : a(t[n])
                };
                return a(r), r.innerHTML
            }(r));
            var u = R.events.chainTrigger("paste.afterCleanup", r);
            if ("string" == typeof u && (r = u), "" !== r) {
                var h = R.o_doc.createElement("div");
                0 <= (h.innerHTML = r).indexOf("<body>") ? (R.html.cleanBlankSpaces(h), R.spaces.normalize(h, !0)) : R.spaces.normalize(h);
                var g = h.getElementsByTagName("span");
                for (n = g.length - 1; 0 <= n; n--) {
                    var m = g[n];
                    0 === m.attributes.length && (m.outerHTML = m.innerHTML)
                }
                if (!0 === R.opts.linkAlwaysBlank) {
                    var v = h.getElementsByTagName("a");
                    for (n = v.length - 1; 0 <= n; n--) {
                        var E = v[n];
                        E.getAttribute("target") || E.setAttribute("target", "_blank")
                    }
                }
                var b = R.selection.element(), T = !1;
                if (b && be(b).parentsUntil(R.el, "ul, ol").length && (T = !0), T) {
                    var A = h.children;
                    1 == A.length && 0 <= ["OL", "UL"].indexOf(A[0].tagName) && (A[0].outerHTML = A[0].innerHTML)
                }
                if (!d) {
                    var C = h.getElementsByTagName("br");
                    for (n = C.length - 1; 0 <= n; n--) {
                        var S = C[n];
                        R.node.isBlock(S.previousSibling) && S.parentNode.removeChild(S)
                    }
                }
                if (R.opts.enter == be.FE.ENTER_BR) for (n = (i = h.querySelectorAll("p, div")).length - 1; 0 <= n; n--) 0 === (a = i[n]).attributes.length && (a.outerHTML = a.innerHTML + (a.nextSibling && !R.node.isEmpty(a) ? "<br>" : "")); else if (R.opts.enter == be.FE.ENTER_DIV) for (n = (i = h.getElementsByTagName("p")).length - 1; 0 <= n; n--) 0 === (a = i[n]).attributes.length && (a.outerHTML = "<div>" + a.innerHTML + "</div>"); else R.opts.enter == be.FE.ENTER_P && 1 == h.childNodes.length && "P" == h.childNodes[0].tagName && 0 === h.childNodes[0].attributes.length && (h.childNodes[0].outerHTML = h.childNodes[0].innerHTML);
                r = h.innerHTML, c && (r = function (e) {
                    var t, n = R.o_doc.createElement("div");
                    n.innerHTML = e;
                    var r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + be.FE.VOID_ELEMENTS.join("):not(") + "):not(" + R.opts.htmlAllowedEmptyTags.join("):not(") + ")");
                    for (; r.length;) {
                        for (t = 0; t < r.length; t++) r[t].parentNode.removeChild(r[t]);
                        r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + be.FE.VOID_ELEMENTS.join("):not(") + "):not(" + R.opts.htmlAllowedEmptyTags.join("):not(") + ")")
                    }
                    return n.innerHTML
                }(r)), R.html.insert(r, !0)
            }
            R.events.trigger("paste.after"), R.undo.saveStep(L), L = null, R.undo.saveStep()
        }
        ...
        function x(e) {
            ...
            for (var r = d(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
                var i = r[r.length - 1];
                if (R.html.defaultTag() && "div" != R.html.defaultTag()) i.querySelector(R.html.blockTagsQuery()) ? i.outerHTML = i.innerHTML : i.outerHTML = "<" + R.html.defaultTag() + ">" + i.innerHTML + "</" + R.html.defaultTag() + ">"; else {
        ...
        function c(e) {
            if (e.originalEvent && e.originalEvent.target && e.originalEvent.target.nodeType == Node.TEXT_NODE) try {
                R.win.localStorage.setItem("fr-dragged-content-html", e.originalEvent.dataTransfer.getData("text/html")), R.win.localStorage.setItem("fr-dragged-content-text", e.originalEvent.dataTransfer.getData("text/plain"))
            } catch (t) {
            }
        }

        function f() {
            R.el.removeEventListener("copy", e), R.el.removeEventListener("cut", e), R.el.removeEventListener("paste", t)
        }

        return {
            _init: function () {
                R.el.addEventListener("copy", e), R.el.addEventListener("cut", e), R.el.addEventListener("paste", t, {capture: !0}), R.events.on("drop", r), R.browser.msie && R.browser.version < 11 && (R.events.on("mouseup", function (e) {
                    2 == e.button && (setTimeout(function () {
                        a = !1
                    }, 50), a = !0)
                }, !0), R.events.on("beforepaste", t)), R.events.on("dragstart", c, !0), R.events.on("destroy", f)
            }, cleanEmptyTagsAndDivs: x, getRtfClipboard: function () {
                return o
            }, saveCopiedText: n, clean: l
        }
    }, be.extend(be.FE.DEFAULTS, {
        shortcutsEnabled: [],
        shortcutsHint: !0
    ...
    }, be.FE.RegisterShortcut(be.FE.KEYCODE.E, "show", null, "E", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.B, "bold", null, "B", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.I, "italic", null, "I", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.U, "underline", null, "U", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.S, "strikeThrough", null, "S", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.CLOSE_SQUARE_BRACKET, "indent", null, "]", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.OPEN_SQUARE_BRACKET, "outdent", null, "[", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.Z, "undo", null, "Z", !1, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.Z, "redo", null, "Z", !0, !1), be.FE.RegisterShortcut(be.FE.KEYCODE.Y, "redo", null, "Y", !1, !1), be.FE.MODULES.shortcuts = function (l) {
        var r = null;
        var d = !1;
        ...
        function e(e) {
            ...
            if ("keyup" == e.type && d && t != be.FE.KEYCODE.META) return d = !1;
            "keydown" == e.type && (d = !1);
            var r = (e.shiftKey ? "^" : "") + (e.altKey ? "@" : "") + t,
                i = l.node.blockParent(l.selection.blocks()[0]);
            if (n && be.FE.SHORTCUTS_MAP[r] && (!i || "false" != be(i).attr("contenteditable"))) {
                var a = be.FE.SHORTCUTS_MAP[r].cmd;
                if (a && 0 <= l.opts.shortcutsEnabled.indexOf(a)) {
                    var o, s = be.FE.SHORTCUTS_MAP[r].val;
                    ...
                    if (a && (l.commands[a] || be.FE.COMMANDS[a] && be.FE.COMMANDS[a].callback)) return e.preventDefault(), e.stopPropagation(), "keydown" == e.type && ((l.commands[a] || be.FE.COMMANDS[a].callback)(), d = !0), !1
                }
            }
        }
        ...
        return {
            _init: function () {
                ...
                if (!r) for (var t in r = {}, be.FE.SHORTCUTS_MAP) be.FE.SHORTCUTS_MAP.hasOwnProperty(t) && 0 <= l.opts.shortcutsEnabled.indexOf(be.FE.SHORTCUTS_MAP[t].cmd) && (r[be.FE.SHORTCUTS_MAP[t].cmd + "." + (be.FE.SHORTCUTS_MAP[t].val || "")] = {
        ...
        function a(e, t) {
            ...
            n < 0 && (n = 0), n + i.$tooltip.outerWidth() > be(i.o_win).width() && (n = be(i.o_win).width() - i.$tooltip.outerWidth()), void 0 === t && (t = i.opts.toolbarBottom), e.offset().top - be(window).scrollTop() + e.outerHeight() + 10 >= be(window).height() && (t = !0);
        ...
        return {
            _init: function () {
                ...
                if (l.shared.$overlay || (l.shared.$overlay = be('<div class="fr-overlay">').appendTo("body:first")), s = l.shared.$overlay, l.opts.theme && s.addClass(l.opts.theme + "-theme"), !d[n]) {
                    var r = (i = e, a = t, o = '<div tabIndex="-1" class="fr-modal' + (l.opts.theme ? " " + l.opts.theme + "-theme" : "") + '"><div class="fr-modal-wrapper">', o += '<div class="fr-modal-head">' + i + '<span title="' + l.language.translate("Cancel") + '" class="fr-modal-close">&times;</span></div>', o += '<div tabIndex="-1" class="fr-modal-body">' + a + "</div>", be(o += "</div></div>"));
                    d[n] = {
                        $modal: r,
    ...
    }, be.FE.MODULES.position = function (E) {
        function i() {
        ...
        function n(e) {
            ...
            } else clearTimeout(be(e).css("sticky-timeout")), n.css("top", "0"), n.css("position", ""), n.width(""), n.data("sticky-top", 0), n.removeClass("fr-sticky-on"), E.$box.removeClass("fr-sticky-box")
        }

        function t(e) {
            if (e.offsetWidth) {
                var t, n, r = be(e), i = r.outerHeight(), a = r.data("sticky-top"), o = r.data("sticky-position"),
                    s = be("body" == E.opts.scrollableContainer ? E.o_win : E.opts.scrollableContainer).outerHeight(),
                    l = 0, d = 0;
                "body" !== E.opts.scrollableContainer && (l = E.$sc.offset().top, d = be(E.o_win).outerHeight() - l - s);
                var c = "body" == E.opts.scrollableContainer ? E.helpers.scrollTop() : l, f = r.is(".fr-sticky-on");
                r.data("sticky-parent") || r.data("sticky-parent", r.parent());
                var p = r.data("sticky-parent"), u = p.offset().top, h = p.outerHeight();
            ...
            _init: function () {
                !function () {
                    if (E._stickyElements = [], E.helpers.isIOS()) {
                        ...
                        t(), E.events.$on(be(E.o_win), "scroll", function () {
                            if (E.core.hasFocus()) for (var e = 0; e < E._stickyElements.length; e++) {
                                var t = be(E._stickyElements[e]), n = t.parent(), r = E.helpers.scrollTop();
                                t.outerHeight() < r - n.offset().top && (t.addClass("fr-opacity-0"), t.data("sticky-top", -1), t.data("sticky-scheduled", -1))
                            }
                        }, !0)
                    } else "body" !== E.opts.scrollableContainer && E.events.$on(be(E.opts.scrollableContainer), "scroll", e, !0), E.events.$on(be(E.o_win), "scroll", e, !0), E.events.$on(be(E.o_win), "resize", e, !0), E.events.on("initialized", e), E.events.on("focus", e), E.events.$on(be(E.o_win), "resize", "textarea", e, !0);
                ...
                var t = i();
                e.css({top: 0, left: 0});
                var n = t.top + t.height, r = t.left + t.width / 2 - e.get(0).offsetWidth / 2 + E.helpers.scrollLeft();
        ...
        function t(e, t) {
            setTimeout(function () {
                if ((!e || e.which != be.FE.KEYCODE.ESC) && i.selection.inEditor() && i.core.hasFocus() && !i.popups.areVisible() && i.selection.blocks().length && "false" != be(i.selection.blocks()[0]).closest("table").attr("contenteditable") && (i.opts.toolbarVisibleWithoutSelection || !i.selection.isCollapsed() && !i.keys.isIME() || t)) {
        ...
        return {
            apply: function (e) {
                ...
                if (be(t).parents(".fr-img-caption").length) be(t).css("text-align", e); else {
                    ...
                    for (var n = i.selection.blocks(), r = 0; r < n.length; r++) be(n[r]).css("text-align", e).removeClass("fr-temp-div"), "" === be(n[r]).attr("class") && be(n[r]).removeAttr("class"), "" === be(n[r]).attr("style") && be(n[r]).removeAttr("style");
        ...
        function x(r, e) {
            ...
            for (var L, _, x = {
                ...
                } else if ("/" === c && "/" === g()) $ || "{" === D || x.trim(), x.singleSpace(), N.push(b()), x.newLine(); else if ("@" === c) {
        ...
        function i(r, e) {
            ...
            for (u = {
                TK_START_EXPR: function () {
                    ...
                    x(), S()
                }, TK_WORD: k, TK_RESERVED: k, TK_SEMICOLON: function () {
                    w() && (o.space_before_token = !1);
                    for (; f.mode === D.Statement && !f.if_block && !f.do_block;) x();
                    S()
                }, TK_STRING: function () {
                    ...
                    S(), f.mode === D.ObjectLiteral || f.mode === D.Statement && f.parent.mode === D.ObjectLiteral ? (f.mode === D.Statement && x(), A()) : (o.space_before_token = !0, h.comma_first && T())
            ...
            function b(e) {
                var t = e.newlines;
                if (h.keep_array_indentation && L(f.mode)) for (n = 0; n < t; n += 1) A(0 < n); else if (h.max_preserve_newlines && t > h.max_preserve_newlines && (t = h.max_preserve_newlines), h.preserve_newlines && 1 < e.newlines) {
                    A();
            ...
            function A(e, t) {
                if (!t && ";" !== f.last_text && "," !== f.last_text && "=" !== f.last_text && "TK_OPERATOR" !== l) for (; f.mode === D.Statement && !f.if_block && !f.do_block;) x();
        ...
        function F(t, n) {
            ...
            this.baseIndentString = n, this.indent_string = t, this.previous_line = null, this.current_line = null, this.space_before_token = !1, this.add_outputline = function () {
                ...
                if (!e.multiline_frame && e.mode !== D.ForInitializer && e.mode !== D.Conditional) for (var t = e.start_line_index, n = r.length; t < n;) r[t].remove_indent(), t++
        ...
        function M(y, L, e) {
            var _ = "\n\r\t ".split(""), x = /[0-9]/, N = /[01234567]/, w = /[0123456789abcdefABCDEF]/,
                O = "+ - * / % & ++ -- = += -= *= /= %= == === != !== > < >= <= >> << >>> >>>= >>= <<= && &= | || ! ~ , : ? ^ ^= |= :: =>".split(" ");
            ...
            function o() {
                ...
                if ("`" === r || "'" === r || '"' === r || ("/" === r || L.e4x && "<" === r && y.slice(M - 1).match(/^<([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/)) && ("TK_RESERVED" === t.type && G(t.text, ["return", "case", "throw", "else", "do", "typeof", "yield"]) || "TK_END_EXPR" === t.type && ")" === t.text && t.parent && "TK_RESERVED" === t.parent.type && G(t.parent.text, ["if", "while", "for"]) || G(t.type, ["TK_COMMENT", "TK_START_EXPR", "TK_START_BLOCK", "TK_END_BLOCK", "TK_OPERATOR", "TK_EQUALS", "TK_EOF", "TK_SEMICOLON", "TK_COMMA"]))) {
                    var c = r, f = !1, p = !1;
                    if (e = r, "/" === c) for (var u = !1; M < $ && (f || u || y.charAt(M) !== c) && !Y.newline.test(y.charAt(M));) e += y.charAt(M), f ? f = !1 : (f = "\\" === y.charAt(M), "[" === y.charAt(M) ? u = !0 : "]" === y.charAt(M) && (u = !1)), M += 1; else if (L.e4x && "<" === c) {
            ...
            this.tokenize = function () {
                ...
                for (var r = null, i = [], a = []; !t || "TK_EOF" !== t.type;) {
                    for (n = o(), e = new X(n[1], n[0], I, k); "TK_COMMENT" === e.type || "TK_BLOCK_COMMENT" === e.type || "TK_UNKNOWN" === e.type;) "TK_BLOCK_COMMENT" === e.type && (e.directives = n[2]), a.push(e), n = o(), e = new X(n[1], n[0], I, k);
    ...
    if (be.FE.PLUGINS.colors = function (g) {
        function t() {
        ...
        imageAddNewLine: !1
    }), be.FE.PLUGINS.image = function (f) {
        var p, l, d, c, s, n, u = "https://i.froala.com/upload", t = !1, r = 1, h = 2, g = 3, m = 4, v = 5, E = 6,
            i = {};
        ...
        function a() {
            ...
            if (e || (e = x()), e) {
                ...
                p.hasClass("fr-uploading") ? N() : f.popups.show("image.edit", n, r, t.outerHeight())
            }
        }
        ...
        function A(e) {
            void 0 === e && (e = !0);
            var t, n = Array.prototype.slice.call(f.el.querySelectorAll("img")), r = [];
            for (t = 0; t < n.length; t++) if (r.push(n[t].getAttribute("src")), be(n[t]).toggleClass("fr-draggable", f.opts.imageMove), "" === n[t].getAttribute("class") && n[t].removeAttribute("class"), "" === n[t].getAttribute("style") && n[t].removeAttribute("style"), n[t].parentNode && n[t].parentNode.parentNode && f.node.hasClass(n[t].parentNode.parentNode, "fr-img-caption")) {
            ...
            if (s) for (t = 0; t < s.length; t++) r.indexOf(s[t].getAttribute("src")) < 0 && f.events.trigger("image.removed", [be(s[t])]);
            if (s && e) {
                var o = [];
                for (t = 0; t < s.length; t++) o.push(s[t].getAttribute("src"));
                for (t = 0; t < n.length; t++) o.indexOf(n[t].getAttribute("src")) < 0 && f.events.trigger("image.loaded", [be(n[t])])
            }
            s = n
        }
        ...
        function C() {
            if (l || function () {
                ...
                }, !0)) : (f.shared.$image_resizer = be('<div class="fr-image-resizer"></div>'), l = f.shared.$image_resizer, f.events.$on(l, "mousedown", function (e) {
                    e.stopPropagation()
                }, !0), f.opts.imageResize && (l.append(o("nw") + o("ne") + o("sw") + o("se")), f.shared.$img_overlay = be('<div class="fr-image-overlay"></div>'), c = f.shared.$img_overlay, e = l.get(0).ownerDocument, be(e).find("body:first").append(c)));
                f.events.on("shared.destroy", function () {
                    l.html("").removeData().remove(), l = null, f.opts.imageResize && (c.remove(), c = null)
                }, !0), f.helpers.isMobile() || f.events.$on(be(f.o_win), "resize", function () {
                    p && !p.hasClass("fr-uploading") ? se(!0) : p && (C(), he(), N(!1))
                });
                if (f.opts.imageResize) {
                    e = l.get(0).ownerDocument, f.events.$on(l, f._mousedown, ".fr-handler", R), f.events.$on(be(e), f._mousemove, y), f.events.$on(be(e.defaultView || e.parentWindow), f._mouseup, L), f.events.$on(c, "mouseleave", L);
                    var r = 1, i = null, a = 0;
                    f.events.on("keydown", function (e) {
                        if (p) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey, n = e.which;
                            (n !== i || 200 < e.timeStamp - a) && (r = 1), (n == be.FE.KEYCODE.EQUALS || f.browser.mozilla && n == be.FE.KEYCODE.FF_EQUALS) && t && !e.altKey ? r = Q.call(this, e, 1, 1, r) : (n == be.FE.KEYCODE.HYPHEN || f.browser.mozilla && n == be.FE.KEYCODE.FF_HYPHEN) && t && !e.altKey ? r = Q.call(this, e, 2, -1, r) : f.keys.ctrlKey(e) || n != be.FE.KEYCODE.ENTER || (p.before("<br>"), k(p)), i = n, a = e.timeStamp
                        }
        ...
        function R(e) {
            ...
            if ("mousedown" == e.type) {
                var n = f.$oel.get(0).ownerDocument, r = n.defaultView || n.parentWindow, i = !1;
                try {
                    i = r.location != r.parent.location && !(r.$ && r.$.FE)
                } catch (s) {
                }
                i && r.frameElement && (t += f.helpers.getPX(be(r.frameElement).offset().left) + r.frameElement.clientLeft)
            }
            (d = be(this)).data("start-x", t), d.data("start-width", p.width()), d.data("start-height", p.height());
            var a = p.width();
        ...
        function y(e) {
            ...
            if (d && p) {
                ...
                if ((d.hasClass("fr-hnw") || d.hasClass("fr-hsw")) && (r = 0 - r), f.opts.imageResizeWithPercent) {
                    ...
                    i = ((i + r) / be(a).outerWidth() * 100).toFixed(2), f.opts.imageRoundPercent && (i = Math.round(i)), S(i + "%"), (t = Ee() ? (f.helpers.getPX(p.parents(".fr-img-caption").css("width")) / be(a).outerWidth() * 100).toFixed(2) : (f.helpers.getPX(p.css("width")) / be(a).outerWidth() * 100).toFixed(2)) === i || f.opts.imageRoundPercent || S(t + "%"), p.css("height", "").removeAttr("height")
        ...
        function F(o, e, s, l, d) {
            ...
            t.onload = function () {
                ...
                _(r)
            }, N(f.language.translate("Loading image")), t.src = o
        }
        ...
        function M(e) {
            ...
            var t = this.status, n = this.response, r = this.responseXML, i = this.responseText;
            try {
                if (f.opts.imageUploadToS3) if (201 == t) {
                    var a = function (e) {
                        try {
                            var t = be(e).find("Location").text(), n = be(e).find("Key").text();
                    ...
                    a && F(a, !1, [], e, n || r)
                } else _(m, n || r, e); else if (200 <= t && t < 300) {
                    var o = function (e) {
                        try {
            ...
            if (void 0 !== e && 0 < e.length) {
                ...
                if ((null === f.opts.imageUploadURL || f.opts.imageUploadURL == u) && !f.opts.imageUploadToS3) return o = r, s = t || p, (l = new FileReader).onload = function () {
                    ...
                    if (l.result.indexOf("svg+xml") < 0) {
                        ...
                        e = window.URL.createObjectURL(new Blob([new Uint8Array(n)], {type: o.type})), f.image.insert(e, !1, null, s)
                    }
                }, N(), l.readAsDataURL(o), !1;
                ...
                if (f.drag_support.formdata && (n = f.drag_support.formdata ? new FormData : null), n) {
                    ...
                    f.opts.imageUploadToS3 && (a = f.opts.imageUploadToS3.uploadURL ? f.opts.imageUploadToS3.uploadURL : "https://" + f.opts.imageUploadToS3.region + ".amazonaws.com/" + f.opts.imageUploadToS3.bucket), function (t, n, e, i) {
                        function a() {
                            var e = be(this);
                            e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), f.placeholder.refresh(), k(e), C(), N(), f.edit.off(), t.onload = function () {
                                M.call(t, e)
        ...
        function W(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && n.type && -1 !== n.type.indexOf("image") && 0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ""))) {
                    ...
                    f.markers.remove(), f.markers.insertAtPoint(e.originalEvent), f.$el.find(".fr-marker").replaceWith(be.FE.MARKERS), 0 === f.$el.find(".fr-marker").length && f.selection.setAtEnd(f.el), f.popups.hideAll();
                    ...
                    return f.opts.iframe && (a += f.$iframe.offset().top, i += f.$iframe.offset().left), f.popups.show("image.insert", i, a), N(), 0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, "")) ? (se(!0), K(t.files)) : _(E), e.preventDefault(), e.stopPropagation(), !1
                }
            }
        }
        ...
        function z(e) {
            ...
            var a = f.opts.imageInsertButtons.indexOf("imageUpload"),
                o = f.opts.imageInsertButtons.indexOf("imageByURL"), s = "";
        ...
        function Z(e) {
            (e = e || ve()) && !1 !== f.events.trigger("image.beforeRemove", [e]) && (f.popups.hideAll(), ge(), se(!0), f.undo.canDo() || f.undo.saveStep(), e.get(0) == f.el ? e.removeAttr("src") : (e.get(0).parentNode && "A" == e.get(0).parentNode.tagName ? (f.selection.setBefore(e.get(0).parentNode) || f.selection.setAfter(e.get(0).parentNode) || e.parent().after(be.FE.MARKERS), be(e.get(0).parentNode).remove()) : (f.selection.setBefore(e.get(0)) || f.selection.setAfter(e.get(0)) || e.after(be.FE.MARKERS), e.remove()), f.html.fillEmptyBlocks(), f.selection.restore()), f.undo.saveStep())
        }

        function J(e) {
            var t = e.which;
            if (p && (t == be.FE.KEYCODE.BACKSPACE || t == be.FE.KEYCODE.DELETE)) return e.preventDefault(), e.stopPropagation(), Z(), !1;
            if (p && t == be.FE.KEYCODE.ESC) {
                var n = p;
                return se(!0), f.selection.setAfter(n.get(0)), f.selection.restore(), e.preventDefault(), !1
            }
            if (p && (t == be.FE.KEYCODE.ARROW_LEFT || t == be.FE.KEYCODE.ARROW_RIGHT)) {
                var r = p.get(0);
                return se(!0), t == be.FE.KEYCODE.ARROW_LEFT ? f.selection.setBefore(r) : f.selection.setAfter(r), f.selection.restore(), e.preventDefault(), !1
            }
            return p && t === be.FE.KEYCODE.TAB ? (e.preventDefault(), e.stopPropagation(), se(!0), !1) : p && t != be.FE.KEYCODE.F10 && !f.keys.isBrowserAction(e) ? (e.preventDefault(), e.stopPropagation(), !1) : void 0
        }
        ...
        function te(e) {
            ...
            p = be(e), C(), a(), he(), N(), p.one("load", function () {
                C(), be(f.popups.get("image.insert").get(0)).find("div.fr-active.fr-error").length < 1 && N()
            });
            for (var t = be(e).attr("src").split(","), n = atob(t[1]), r = [], i = 0; i < n.length; i++) r.push(n.charCodeAt(i));
            K([new Blob([new Uint8Array(r)], {type: t[0].replace(/data\:/g, "").replace(/;base64/g, "")})], p)
        }
        ...
        function ne() {
            f.opts.imagePaste ? f.$el.find("img[data-fr-image-pasted]").each(function (e, r) {
                if (f.opts.imagePasteProcess) {
                    ...
                    t && "auto" != t && (t += f.opts.imageResizeWithPercent ? "%" : "px"), be(r).css("width", t).removeClass("fr-dii fr-dib fr-fir fr-fil"), fe(be(r), f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign)
                }
                if (0 === r.src.indexOf("data:")) te(r); else if (0 === r.src.indexOf("blob:") || 0 === r.src.indexOf("http") && f.opts.imageUploadRemoteUrls && f.opts.imageCORSProxy) {
                    var n = new Image;
                    n.crossOrigin = "Anonymous", n.onload = function () {
                        var e, t = f.o_doc.createElement("CANVAS"), n = t.getContext("2d");
                ...
                } else 0 !== r.src.indexOf("http") || 0 === r.src.indexOf("https://mail.google.com/mail") ? (f.selection.save(), be(r).remove(), f.selection.restore()) : be(r).removeAttr("data-fr-image-pasted")
            }) : f.$el.find("img[data-fr-image-pasted]").remove()
        }

        function re(e) {
            var t = e.target.result, n = f.opts.imageDefaultWidth;
        ...
        function ie(e) {
            if (e && e.clipboardData && e.clipboardData.items) {
                var t = null, n = e.clipboardData;
                if (n.types && -1 != [].indexOf.call(n.types, "text/rtf") || n.getData("text/rtf")) t = n.items[0].getAsFile(); else for (var r = 0; r < n.items.length && !(t = n.items[r].getAsFile()); r++) ;
        ...
        function oe(e) {
            ...
            for (var t = 0; t < be.FE.INSTANCES.length; t++) be.FE.INSTANCES[t] != f && be.FE.INSTANCES[t].events.trigger("image.hideResizer");
            f.toolbar.disable(), e && (e.stopPropagation(), e.preventDefault()), f.helpers.isMobile() && (f.events.disableBlur(), f.$el.blur(), f.events.enableBlur()), f.opts.iframe && f.size.syncIframe(), p = be(this), ge(), C(), a(), f.browser.msie ? (f.popups.areVisible() && f.events.disableBlur(), f.win.getSelection && (f.win.getSelection().removeAllRanges(), f.win.getSelection().addRange(f.doc.createRange()))) : f.selection.clear(), f.helpers.isIOS() && (f.events.disableBlur(), f.$el.blur()), f.button.bulkRefresh(), f.events.trigger("video.hideResizer")
        }
        ...
        return {
            _init: function () {
                ...
                f.events.$on(f.$el, f._mousedown, "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
                    ...
                    if (e.shiftKey && "" === f.selection.text().replace(/\n/g, "") && f.keys.isArrow(e.which)) {
                        var t = f.selection.element(), n = f.selection.endElement();
                        t && "IMG" == t.tagName ? k(be(t)) : n && "IMG" == n.tagName && k(be(n))
                    }
                    ...
                    f.node.isElement(t) && (f.opts.enter === be.FE.ENTER_BR ? e.after("<br>") : be(f.node.blockParent(e.get(0))).after("<" + f.html.defaultTag() + "><br></" + f.html.defaultTag() + ">"))
                    ...
                    if (p && e.which == be.FE.KEYCODE.ENTER) return !1
                }, !0), f.events.$on(f.$el, "keydown", function () {
                    var e = f.selection.element();
                    (e.nodeType === Node.TEXT_NODE || "BR" == e.tagName && f.node.isLastSibling(e)) && (e = e.parentNode), f.node.hasClass(e, "fr-inner") || (f.node.hasClass(e, "fr-img-caption") || (e = be(e).parents(".fr-img-caption").get(0)), f.node.hasClass(e, "fr-img-caption") && (be(e).after(be.FE.INVISIBLE_SPACE + be.FE.MARKERS), f.selection.restore()))
                    ...
                    if (p && f.popups.isVisible("image.edit") && !f.popups.get("image.edit").find(":focus").length) {
                        var t = ve();
                        Ee() ? (t.before(be.FE.START_MARKER), t.after(be.FE.END_MARKER), f.selection.restore(), f.paste.saveCopiedText(t.get(0).outerHTML, t.text())) : (ge(), f.paste.saveCopiedText(p.get(0).outerHTML, p.attr("alt"))), "copy" == e.type ? setTimeout(function () {
                            k(p)
                    ...
                    var t = e.which;
                    t == be.FE.KEYCODE.C && f.keys.ctrlKey(e) ? f.events.trigger("window.copy") : t == be.FE.KEYCODE.X && f.keys.ctrlKey(e) && f.events.trigger("window.cut")
                }), f.events.$on(be(f.o_win), "keydown", function (e) {
                    var t = e.which;
                    if (p && t == be.FE.KEYCODE.BACKSPACE) return e.preventDefault(), !1
                }), f.events.$on(f.$win, "keydown", function (e) {
                    var t = e.which;
                    p && p.hasClass("fr-uploading") && t == be.FE.KEYCODE.ESC && p.trigger("abortUpload")
                ...
                }), f.opts.iframe && f.events.on("image.loaded", f.size.syncIframe), f.$wp && (A(), f.events.on("contentChanged", A)), f.events.$on(be(f.o_win), "orientationchange.image", function () {
                    setTimeout(function () {
                        p && k(p)
                    }, 100)
                }), x(!0), z(!0), j(!0), V(!0), f.events.on("node.remove", function (e) {
                    if ("IMG" == e.get(0).tagName) return Z(e), !1
                })
            },
            showInsertPopup: function () {
                var e = f.$tb.find('.fr-command[data-cmd="insertImage"]'), t = f.popups.get("image.insert");
                if (t || (t = z()), w(), !t.hasClass("fr-active")) if (f.popups.refresh("image.insert"), f.popups.setContainer("image.insert", f.$tb), e.is(":visible")) {
                    var n = e.offset().left + e.outerWidth() / 2,
            ...
            insertByURL: function () {
                var e = f.popups.get("image.insert").find(".fr-image-by-url-layer input");
                if (0 < e.val().length) {
                    N(), O(f.language.translate("Loading image"));
                    var t = e.val().trim();
                    if (f.opts.imageUploadRemoteUrls && f.opts.imageCORSProxy && f.opts.imageUpload) {
                        var n = new XMLHttpRequest;
                        n.onload = function () {
                            200 == this.status ? K([new Blob([this.response], {type: this.response.type || "image/png"})], p) : _(r)
                        }, n.onerror = function () {
                            F(t, !0, [], p)
            ...
            replace: he,
            back: function () {
                p ? (f.events.disableBlur(), be(".fr-popup input:focus").blur(), k(p)) : (f.events.disableBlur(), f.selection.restore(), f.events.enableBlur(), f.popups.hide("image.insert"), f.toolbar.showInline())
            },
            get: me,
            getEl: ve,
            insert: F,
            ...
            toggleCaption: function () {
                ...
                if (p && !Ee()) {
                    ...
                    e.wrap("<span " + (f.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + p.attr("class") + '" style="' + (f.opts.useClasses ? "" : e.attr("style")) + '" draggable="false"></span>'), e.wrap('<span class="fr-img-wrap"></span>'), p.after('<span class="fr-inner"' + (f.browser.mozilla ? "" : ' contenteditable="true"') + ">" + be.FE.START_MARKER + f.language.translate("Image Caption") + be.FE.END_MARKER + "</span>"), p.removeAttr("class").removeAttr("style").removeAttr("width"), p.parents(".fr-img-caption").css("width", r), se(!0), f.selection.restore()
                } else e = ve(), p.insertAfter(e), p.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), k(p)
            },
            hasCaption: Ee,
            exitEdit: se,
            edit: k
        ...
        function t(i) {
            ...
            N(!1), a.onload = function () {
                ...
                o.append(n).append(be(s.icon.create("imageManagerDelete")).addClass("fr-delete-img").attr("title", s.language.translate("Delete"))).append(be(s.icon.create("imageManagerInsert")).addClass("fr-insert-img").attr("title", s.language.translate("Insert"))), c.find(".fr-selected-tag").each(function (e, t) {
                    ...
                    o.removeClass("fr-empty"), o.height("auto"), p++, x(_(parseInt(n.parent().attr("class").match(/fr-image-(\d+)/)[1], 10) + 1)), N(!1), p % s.opts.imageManagerPageSize == 0 && y()
                }), s.events.trigger("imageManager.imageLoaded", [n])
            }, a.onerror = function () {
                p++, o.remove(), x(_(parseInt(o.attr("class").match(/fr-image-(\d+)/)[1], 10) + 1)), k(e, i), p % s.opts.imageManagerPageSize == 0 && y()
        ...
        function I(e) {
            ...
            confirm(t) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [n]) && (n.parent().addClass("fr-image-deleting"), be.ajax({
                ...
                data: be.extend(be.extend({src: n.attr("src")}, w(n)), s.opts.imageManagerDeleteParams),
        ...
        return n[e] = "Image cannot be loaded from the passed link.", n[m] = "Error during load images request.", n[v] = "Missing imageManagerLoadURL option.", n[E] = "Parsing load response failed.", n[b] = "Missing image thumb.", n[T] = "Missing image URL.", n[A] = "Error during delete image request.", n[C] = "Missing imageManagerDeleteURL option.", {
            require: ["image"], _init: function () {
                ...
                }), r.on("scroll", y), s.events.bindClick(l, "#fr-modal-more-" + s.sid, D), s.events.bindClick(c, "a", M)), i.show(), a.find(".fr-list-column").empty(), s.opts.imageManagerLoadURL ? be.ajax({
    ...
    be.FE.DEFAULTS.imageInsertButtons.push("imageManager"), be.FE.RegisterCommand("imageManager", {
        ...
        return {
            _init: function () {
                ...
                i.selection.save(), i.html.wrap(!0, !0, !0, !0), i.selection.restore();
                var t = i.selection.blocks();
                t.length && be(t[0]).parent().is("td") && i.format.applyStyle("line-height", e.toString()), i.selection.save();
        ...
        function c(e, t, n) {
            ...
            if (o) {
                ...
                r ? (r.wrap('<a href="' + e + '"></a>'), f.image.hasCaption() && r.parent().append(r.parents(".fr-img-caption").find(".fr-inner"))) : (f.format.remove("a"), f.selection.isCollapsed() ? (t = 0 === t.length ? i : t, f.html.insert('<a href="' + e + '">' + be.FE.START_MARKER + t.replace(/&/g, "&amp;").replace(/</, "&lt;", ">", "&gt;") + be.FE.END_MARKER + "</a>"), f.selection.restore()) : 0 < t.length && t != f.selection.text().replace(/\n/g, "") ? (f.selection.remove(), f.html.insert('<a href="' + e + '">' + be.FE.START_MARKER + t.replace(/&/g, "&amp;") + be.FE.END_MARKER + "</a>"), f.selection.restore()) : (!function () {
        ...
        return {
            _init: function () {
                ...
                for (r.rel && (i.rel = r.rel), n = 0; n < a.length; n++) r[(t = be(a[n])).attr("name")] ? t.val(r[t.attr("name")]) : "text" != t.attr("name") && t.val("");
        ...
        function i(e, t) {
            ...
            for (var a = 0; a < e.length; a++) if ("TD" != e[a].tagName && "TH" != e[a].tagName && "LI" != e[a].tagName) {
        ...
        function e(e) {
            if ("indent" == e || "outdent" == e) {
                var t = !1, n = f.selection.blocks(), r = [];
                if ("outdent" == e) {
                    if (n[0].previousSibling && "LI" == n[0].previousSibling.tagName) return;
                    if ("LI" == n[0].parentElement.tagName) return
                } else if ("indent" == e && (!n[0].previousSibling || "LI" != n[0].previousSibling.tagName)) return;
                for (var i = 0; i < n.length; i++) "LI" == n[i].tagName ? (t = !0, r.push(n[i])) : "LI" == n[i].parentNode.tagName && (t = !0, r.push(n[i].parentNode));
                t && ("indent" == e ? o(r) : s(r))
            }
        }
        ...
        return {
            _init: function () {
                ...
                if (f.selection.save(), function (e, t) {
                    ...
                    for (n = 0; n < r.length; n++) "LI" == r[n].tagName && (be(r[n].parentNode).css("list-style-type", "default" === t ? "" : t), 0 === (be(r[n].parentNode).attr("style") || "").length && be(r[n].parentNode).removeAttr("style"))
                }
        ...
        callback: function () {
            var e = this;
            e.shared.$qi_image_input || (e.shared.$qi_image_input = be('<input accept="image/' + e.opts.imageAllowedTypes.join(", image/").toLowerCase() + '" name="quickInsertImage' + this.id + '" style="display: none;" type="file">'), be("body:first").append(e.shared.$qi_image_input), e.events.$on(e.shared.$qi_image_input, "change", function () {
        ...
        function u() {
            ...
            if (e) {
                ...
                if (t || (t = p()), t) {
                    ...
                    var n = w(e), r = (n.left + n.right) / 2, i = n.bottom;
        ...
        function d() {
            ...
            if (i) {
                ...
                var o = w(i), s = (o.left + o.right) / 2, l = o.bottom;
        ...
        function g(e) {
            ...
            if (0 < t.length) {
                ...
                for (n = 0; n < a[r].length; n++) {
                    ...
                    } else s += '<td style="' + be(a[r][n]).attr("style") + '" ><br></td>'
                }
        ...
        function w(e) {
            var t = N(e), n = be(e[t.min_i][t.min_j]), r = be(e[t.min_i][t.max_j]), i = be(e[t.max_i][t.min_j]);
            return {
        ...
        function O(t, n) {
            if (be(t).is(n)) _(), be(t).addClass("fr-selected-cell"); else {
                x(), T.edit.off();
        ...
        function e(e) {
            ...
            if (0 < Q().length && !t && k(), !T.edit.isDisabled() || T.popups.isVisible("table.edit")) if (1 != e.which || 1 == e.which && T.helpers.isMac() && e.ctrlKey) (3 == e.which || 1 == e.which && T.helpers.isMac() && e.ctrlKey) && t && k(); else if (a = !0, t) {
        ...
        function n(e) {
            ...
            if (i || T.$tb.is(e.target) || T.$tb.is(be(e.target).closest(T.$tb.get(0))) || (0 < Q().length && T.toolbar.enable(), _()), !(1 != e.which || 1 == e.which && T.helpers.isMac() && e.ctrlKey)) {
                if (a = !1, i) i = !1, I(e) || 1 != Q().length ? 0 < Q().length && (T.selection.isCollapsed() ? u() : (_(), T.edit.on())) : _();
                if (b) {
            ...
            if (t && "TD" != t.tagName && "TH" != t.tagName && (0 < n.closest("td").length ? t = n.closest("td") : 0 < n.closest("th").length && (t = n.closest("th"))), !t || "TD" != t.tagName && "TH" != t.tagName) A && n.get(0) != A.get(0) && n.parent().get(0) != A.get(0) && T.core.sameInstance(A) && B(); else {
                ...
                if (Math.abs(e.pageX - a) <= T.opts.tableResizerOffset || Math.abs(o - e.pageX) <= T.opts.tableResizerOffset) {
                    ...
                    "rtl" != T.opts.direction ? e.pageX - a <= T.opts.tableResizerOffset ? (d = a, 0 < u.col ? (c = a - Y(u.col - 1, p) + T.opts.tableResizingLimit, f = a + Y(u.col, p) - T.opts.tableResizingLimit, s = u.col - 1, l = u.col) : (s = null, l = 0, c = r.offset().left - 1 - parseInt(r.css("margin-left"), 10), f = r.offset().left - 1 + r.width() - p[0].length * T.opts.tableResizingLimit)) : o - e.pageX <= T.opts.tableResizerOffset && (d = o, h.col < p[h.row].length && p[h.row][h.col + 1] ? (c = o - Y(h.col, p) + T.opts.tableResizingLimit, f = o + Y(h.col + 1, p) - T.opts.tableResizingLimit, s = h.col, l = h.col + 1) : (s = h.col, l = null, c = r.offset().left - 1 + p[0].length * T.opts.tableResizingLimit, f = i.offset().left - 1 + i.width() + parseFloat(i.css("padding-left")))) : o - e.pageX <= T.opts.tableResizerOffset ? (d = o, 0 < u.col ? (c = o - Y(u.col, p) + T.opts.tableResizingLimit, f = o + Y(u.col - 1, p) - T.opts.tableResizingLimit, s = u.col, l = u.col - 1) : (s = null, l = 0, c = r.offset().left + p[0].length * T.opts.tableResizingLimit, f = i.offset().left - 1 + i.width() + parseFloat(i.css("padding-left")))) : e.pageX - a <= T.opts.tableResizerOffset && (d = a, h.col < p[h.row].length && p[h.row][h.col + 1] ? (c = a - Y(h.col + 1, p) + T.opts.tableResizingLimit, f = a + Y(h.col, p) - T.opts.tableResizingLimit, s = h.col + 1, l = h.col) : (s = h.col, l = null, c = i.offset().left + parseFloat(i.css("padding-left")), f = r.offset().left - 1 + r.width() - p[0].length * T.opts.tableResizingLimit)), A || (T.shared.$table_resizer || (T.shared.$table_resizer = be('<div class="fr-table-resizer"><div></div></div>')), A = T.shared.$table_resizer, T.events.$on(A, "mousedown", function (e) {
                        return !T.core.sameInstance(A) || (0 < Q().length && k(), 1 == e.which ? (T.selection.save(), b = !0, A.addClass("fr-moving"), x(), T.edit.off(), A.find("div").css("opacity", 1), !1) : void 0)
            ...
            T.opts.tableResizer && (!T.popups.areVisible() || T.popups.areVisible() && T.popups.isVisible("table.edit")) && U(e, t), !T.opts.tableInsertHelper || T.popups.areVisible() || T.$tb.hasClass("fr-inline") && T.$tb.is(":visible") || function (e, t) {
                if (0 === Q().length) {
                    ...
                    if (t && ("HTML" == t.tagName || "BODY" == t.tagName || T.node.isElement(t))) for (n = 1; n <= T.opts.tableInsertHelperOffset; n++) {
                        ...
                        if (r && ("TH" == r.tagName || "TD" == r.tagName || "TABLE" == r.tagName) && (be(r).parents(".fr-wrapper").length || T.opts.iframe) && "false" != be(r).closest("table").attr("contenteditable")) return K(e, be(r).closest("table"));
                        if (i = T.doc.elementFromPoint(e.pageX - T.win.pageXOffset + n, e.pageY - T.win.pageYOffset), be(i).hasClass("fr-tooltip")) return;
                        if (i && ("TH" == i.tagName || "TD" == i.tagName || "TABLE" == i.tagName) && (be(i).parents(".fr-wrapper").length || T.opts.iframe) && "false" != be(i).closest("table").attr("contenteditable")) return H(e, be(i).closest("table"))
                    }
        ...
        return {
            _init: function () {
                ...
                if (!T.helpers.isMobile()) {
                    b = i = a = !1, T.events.$on(T.$el, "mousedown", e), T.popups.onShow("image.edit", function () {
                    ...
                    }), T.events.$on(T.$el, "mouseenter", "th, td", D), T.events.$on(T.$win, "mouseup", n), T.opts.iframe && T.events.$on(be(T.o_win), "mouseup", n), T.events.$on(T.$win, "mousemove", V), T.events.$on(be(T.o_win), "scroll", z), T.events.on("contentChanged", function () {
                        ...
                        e.shiftKey ? !1 === function (e) {
                            ...
                            if (n.length && ("TD" == (n = n[0]).tagName || "TH" == n.tagName)) {
                                ...
                                if (r && "TABLE" == r.tagName && (be.FE.KEYCODE.ARROW_LEFT == t || be.FE.KEYCODE.ARROW_UP == t || be.FE.KEYCODE.ARROW_RIGHT == t || be.FE.KEYCODE.ARROW_DOWN == t) && (0 < Q().length && k(), T.browser.webkit && (be.FE.KEYCODE.ARROW_UP == t || be.FE.KEYCODE.ARROW_DOWN == t))) {
                                    var i = T.selection.ranges(0).startContainer;
                                    if (i.nodeType == Node.TEXT_NODE && (be.FE.KEYCODE.ARROW_UP == t && (i.previousSibling && "BR" !== i.previousSibling.tagName || i.previousSibling && "BR" === i.previousSibling.tagName && i.previousSibling.previousSibling) || be.FE.KEYCODE.ARROW_DOWN == t && (i.nextSibling && "BR" !== i.nextSibling.tagName || i.nextSibling && "BR" === i.nextSibling.tagName && i.nextSibling.nextSibling))) return;
                                    e.preventDefault(), e.stopPropagation();
                ...
                if (1 < Q().length && (0 === T.$el.find("th.fr-selected-cell").length || 0 === T.$el.find("td.fr-selected-cell").length)) {
                    L();
                    var e, t, n = N(S()), r = T.$el.find(".fr-selected-cell"), i = be(r[0]),
    ...
    }), be.FE.DefineIcon("tableCells", {NAME: "square-o", FA5NAME: "square"}), be.FE.RegisterCommand("tableCells", {
        type: "dropdown",
        focus: !1,
        title: "Cell",
        ...
        html: '<iframe width="640" height="360" src="{url}" frameborder="0" allowfullscreen></iframe>',
        provider: "vidyard"
    }],be.FE.VIDEO_EMBED_REGEX = /^\W*((<iframe(.|\n)*>(\s|\n)*<\/iframe>)|(<embed(.|\n)*>))\W*$/i,be.FE.PLUGINS.video = function (p) {
        var s, c, f, u, r, n, l = "https://i.froala.com/upload", d = 2, h = 3, g = 4, m = 5, v = 6, i = {};
        ...
        function a() {
            ...
            if (e || (e = function () {
                ...
                if (0 < p.opts.videoEditButtons.length) {
                    ...
                    var t = {buttons: e += "</div>"}, n = p.popups.create("video.edit", t);
        ...
        function o(e) {
            ...
            var r, i = "", a = p.opts.videoInsertButtons.indexOf("videoUpload"),
        ...
        function A(s, e, l, d, c) {
            ...
            C("Loading video"), function () {
                ...
                if (d) {
                    ...
                    a && "auto" != a && (a += "px");
                    var o = be('<span contenteditable="false" draggable="true" class="fr-video fr-dv' + p.opts.videoDefaultDisplay[0] + ("center" != p.opts.videoDefaultAlign ? " fr-fv" + p.opts.videoDefaultAlign[0] : "") + '"><video src="' + e + '" ' + i + (a ? ' style="width: ' + a + ';" ' : "") + " controls>" + p.language.translate("Your browser does not support HTML5 video.") + "</video></span>");
        ...
        function _(e) {
            ...
            var t = this.status, n = this.response, r = this.responseXML, i = this.responseText;
            try {
                if (p.opts.videoUploadToS3) if (201 == t) {
                    var a = function (e) {
                        try {
                            var t = be(e).find("Location").text(), n = be(e).find("Key").text();
                    ...
                    a && A(a, !1, [], e, n || r)
                } else H(g, n || r); else if (200 <= t && t < 300) {
                    var o = function (e) {
                        try {
        ...
        function O(e) {
            ...
            if (!t || !n) return !1;
            if ("mousedown" == e.type) {
                var r = p.$oel.get(0).ownerDocument, i = r.defaultView || r.parentWindow, a = !1;
                try {
                    a = i.location != i.parent.location && !(i.$ && i.$.FE)
                } catch (o) {
                }
                a && i.frameElement && (t += p.helpers.getPX(be(i.frameElement).offset().left) + i.frameElement.clientLeft, n = e.clientY + p.helpers.getPX(be(i.frameElement).offset().top) + i.frameElement.clientTop)
            }
            p.undo.canDo() || p.undo.saveStep(), (c = be(this)).data("start-x", t), c.data("start-y", n), s.show(), p.popups.hideAll(), P()
        }
        ...
        function F() {
            var e, t = Array.prototype.slice.call(p.el.querySelectorAll("video, .fr-video > *")), n = [];
            for (e = 0; e < t.length; e++) n.push(t[e].getAttribute("src")), be(t[e]).toggleClass("fr-draggable", p.opts.videoMove), "" === t[e].getAttribute("class") && t[e].removeAttribute("class"), "" === t[e].getAttribute("style") && t[e].removeAttribute("style");
            if (r) for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("src")) < 0 && p.events.trigger("video.removed", [be(r[e])]);
            r = t
        }
        ...
        function M() {
            f || function () {
                ...
                if (p.shared.$video_resizer ? (f = p.shared.$video_resizer, s = p.shared.$vid_overlay, p.events.on("destroy", function () {
                    f.removeClass("fr-active").appendTo(be("body:first"))
                }, !0)) : (p.shared.$video_resizer = be('<div class="fr-video-resizer"></div>'), f = p.shared.$video_resizer, p.events.$on(f, "mousedown", function (e) {
                    e.stopPropagation()
                }, !0), p.opts.videoResize && (f.append(t("nw") + t("ne") + t("sw") + t("se")), p.shared.$vid_overlay = be('<div class="fr-video-overlay"></div>'), s = p.shared.$vid_overlay, e = f.get(0).ownerDocument, be(e).find("body:first").append(s))), p.events.on("shared.destroy", function () {
                    f.html("").removeData().remove(), f = null, p.opts.videoResize && (s.remove(), s = null)
                }, !0), p.helpers.isMobile() || p.events.$on(be(p.o_win), "resize.video", function () {
                    B(!0)
                }), p.opts.videoResize) {
                    e = f.get(0).ownerDocument, p.events.$on(f, p._mousedown, ".fr-handler", O), p.events.$on(be(e), p._mousemove, I), p.events.$on(be(e.defaultView || e.parentWindow), p._mouseup, k), p.events.$on(s, "mouseleave", k);
                    var r = 1, i = null, a = 0;
                    p.events.on("keydown", function (e) {
                        if (u) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey, n = e.which;
                            (n !== i || 200 < e.timeStamp - a) && (r = 1), (n == be.FE.KEYCODE.EQUALS || p.browser.mozilla && n == be.FE.KEYCODE.FF_EQUALS) && t && !e.altKey ? r = D.call(this, e, 1, 1, r) : (n == be.FE.KEYCODE.HYPHEN || p.browser.mozilla && n == be.FE.KEYCODE.FF_HYPHEN) && t && !e.altKey && (r = D.call(this, e, 2, -1, r)), i = n, a = e.timeStamp
                        }
        ...
        function $(e) {
            ...
            for (var t = 0; t < be.FE.INSTANCES.length; t++) be.FE.INSTANCES[t] != p && be.FE.INSTANCES[t].events.trigger("video.hideResizer");
            p.toolbar.disable(), p.helpers.isMobile() && (p.events.disableBlur(), p.$el.blur(), p.events.enableBlur()), p.$el.find(".fr-video.fr-active").removeClass("fr-active"), (u = be(this)).addClass("fr-active"), p.opts.iframe && p.size.syncIframe(), Q(), M(), a(), p.selection.clear(), p.button.bulkRefresh(), p.events.trigger("image.hideResizer")
        }
        ...
        function U(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && n.type && -1 !== n.type.indexOf("video")) {
                    ...
                    p.markers.remove(), p.markers.insertAtPoint(e.originalEvent), p.$el.find(".fr-marker").replaceWith(be.FE.MARKERS), p.popups.hideAll();
        ...
        function K(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if (p.drag_support.formdata && (t = p.drag_support.formdata ? new FormData : null), t) {
                    ...
                    a.onload = function () {
                        _.call(a, u)
                    }, a.onerror = x, a.upload.onprogress = N, a.onabort = w, C(), p.events.disableBlur(), p.edit.off(), p.events.enableBlur();
        ...
        function W() {
            if (u) {
                var e = p.popups.get("video.size"), t = u.find("iframe, embed, video");
        ...
        function q(e, t, n) {
            !p.opts.htmlUntouched && p.opts.useClasses ? (e.removeClass("fr-fvl fr-fvr fr-dvb fr-dvi"), e.addClass("fr-fv" + n[0] + " fr-dv" + t[0])) : "inline" == t ? (e.css({display: "inline-block"}), "center" == n ? e.css({"float": "none"}) : "left" == n ? e.css({"float": "left"}) : e.css({"float": "right"})) : (e.css({
                display: "block",
                clear: "both"
        ...
        function j() {
            p.$el.find("video").filter(function () {
                ...
                if (p.browser.safari && this.getAttribute("src") && this.setAttribute("src", this.src), 0 < be(this).parents("span.fr-video").length) return !1;
        ...
        return i[1] = "Video cannot be loaded from the passed link.", i[d] = "No link in upload response.", i[h] = "Error during file upload.", i[g] = "Parsing response failed.", i[m] = "File is too large.", i[v] = "Video file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", p.shared.vid_exit_flag = !1, {
            _init: function () {
                p.opts.videoResponsive && (p.opts.videoResize = !1), p.events.on("drop", U, !0), p.events.on("mousedown window.mousedown", e), p.events.on("window.touchmove", P), p.events.on("mouseup window.mouseup", B), p.events.on("commands.mousedown", function (e) {
                    ...
                    var t = e.which;
                    return !u || t != be.FE.KEYCODE.BACKSPACE && t != be.FE.KEYCODE.DELETE ? u && t == be.FE.KEYCODE.ESC ? (B(!0), e.preventDefault(), !1) : u && t != be.FE.KEYCODE.F10 && !p.keys.isBrowserAction(e) ? (e.preventDefault(), !1) : void 0 : (e.preventDefault(), V(), p.undo.saveStep(), !1)
                ...
                var e = p.$tb.find('.fr-command[data-cmd="insertVideo"]'), t = p.popups.get("video.insert");
            ...
            }, upload: K, insertByURL: function (e) {
                void 0 === e && (e = (p.popups.get("video.insert").find('.fr-video-by-url-layer input[type="text"]').val() || "").trim());
                var t = null;
                if (/^http/.test(e) || (e = "https://" + e), p.helpers.isURL(e)) for (var n = 0; n < be.FE.VIDEO_PROVIDERS.length; n++) {
                ...
                void 0 === e && (e = p.popups.get("video.insert").find(".fr-video-embed-layer textarea").val() || ""), 0 !== e.length && be.FE.VIDEO_EMBED_REGEX.test(e) ? b(e) : (y(p.language.translate("Something went wrong. Please try again.")), p.events.trigger("video.codeError", [e]))
            ...
            }, remove: V, hideProgressBar: S, showSizePopup: function () {
                ...
                if (u) {
                    var n = p.popups.get("video.size"), r = u.find("iframe, embed, video");
        ...
        function t(e) {
            ...
            e || (T.opts.wordAllowedStyleProps = []), 0 === r.indexOf("<colgroup>") && (r = "<table>" + r + "</table>"), r = function (e, t) {
                ...
                var n = (new DOMParser).parseFromString(e, "text/html"), r = n.head, i = n.body, s = function (e) {
                ...
                c(i, function (e) {
                    if (e.nodeType == Node.TEXT_NODE && /\n|\u00a0|\r/.test(e.data)) {
                        if (!/\S| /.test(e.data) && !/[\u00a0]+/.test(e.data)) return e.data == be.FE.UNICODE_NBSP ? (e.data = "\u200b", !0) : 1 == e.data.length && 10 == e.data.charCodeAt(0) ? (e.data = " ", !0) : (A(e), !1);
                ...
                c(i, function (t) {
                    ...
                    if (t.nodeType == Node.ELEMENT_NODE) {
                        if (C(t)) {
                            var n = t.parentNode, r = t.previousSibling, i = function e(t, n, r) {
                                var i = /[0-9a-zA-Z]./gi;
                                var a = !1;
                                ...
                                if (1 == a) {
                                    var h = o.textContent.trim().split(".")[0];
                                    "a" == h ? u = "lower-alpha;" : "A" == h ? u = "upper-alpha;" : "1" == h ? u = "decimal;" : "i" == h ? u = "lower-roman;" : "I" == h ? u = "upper-roman;" : "o" == h && (u = "circle;"), u = "list-style-type: " + u, p = "ol"
                                } else p = "ul";
                                var g = u ? "<" + p + ' style = "' + u + '">' : "<" + p + ">";
                                for (; t;) {
                                    if (!C(t)) {
                                    ...
                                    if ((r = r || m) < m) f = e(t, n, m), g += f.el.outerHTML, t = f.currentNode; else {
                                        if (m < r) break;
                                        t.firstElementChild && t.firstElementChild.firstElementChild && t.firstElementChild.firstElementChild.firstChild && (i.lastIndex = 0, l = i.test(t.firstElementChild.firstElementChild.firstChild.data || t.firstElementChild.firstElementChild.firstChild.firstChild.data || "")), s && s.firstElementChild && s.firstElementChild.firstElementChild && s.firstElementChild.firstElementChild.firstChild && (i.lastIndex = 0, d = i.test(s.firstElementChild.firstElementChild.firstChild.data || s.firstElementChild.firstElementChild.firstChild.firstChild.data || "")), d === undefined || d === l ? (c = S(t, n), g += "<li>" + c + "</li>") : (f = e(t, n, m), g += f.el.outerHTML, t = f.currentNode);
                                        var v = t && t.nextElementSibling;
                                        v && (s = v.previousElementSibling), t && t.parentNode && t.parentNode.removeChild(t), t = v
                                    }
                                }
                                g += "</" + p + ">";
                                var E = document.createElement("div");
                                E.innerHTML = g;
                                var b = E.firstElementChild;
                                return {el: b, currentNode: t}
                            }(t, s).el, a = null;
                    ...
                    if (t.nodeType == Node.COMMENT_NODE) {
                        if (-1 < t.data.indexOf("[if !supportLineBreakNewLine]")) for (var o = t.nextSibling; o;) (o = t.nextSibling) && A(o), o.data && -1 < o.data.indexOf("[endif]") && (o = null);
                        return A(t), !1
                    }
                    return !0
                }), c(i, function (e) {
        ...
        function S(e, a) {
            ...
            if (-1 != ["H1", "H2", "H3", "H4", "H5", "H6"].indexOf(e.tagName)) {
                var t = document.createElement(e.tagName.toLowerCase());
                t.setAttribute("style", e.getAttribute("style")), t.innerHTML = o.innerHTML, o.innerHTML = t.outerHTML
            }
            c(o, function (e) {
                ...
                var n, r;
                return e.nodeType == Node.ELEMENT_NODE && ("mso-list:Ignore" == e.getAttribute("style") && e.parentNode.removeChild(e), e.setAttribute("style", (n = "", r = o.getAttribute("style"), ["line-height", "font-family", "font-size"].forEach(function (e) {
        ...
        function p(e, t) {
            ...
            if ("TR" == n && function (e, t) {
                ...
                for (var n = e.firstElementChild, r = 0, i = !1, a = null; n;) {
                    ...
                    for (var o = n.firstElementChild, s = 1 == n.children.length; o;) "P" != o.tagName || C(o) || s && R(o), o = o.nextElementSibling;
                    if (t) {
