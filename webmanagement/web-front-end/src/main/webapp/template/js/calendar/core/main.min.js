...
!function (e, t) {
    ...
    function V(e, t, n, r) {
        var i = j([t, 0, 1 + A(t, n, r)]), o = B(e), a = Math.round(N(i, o));
    ...
    function ve(e) {
        var t = Math.floor(N(e.start, e.end)) || 1, n = B(e.start);
        ...
        for (var a in o = we(o, function (e) {
            ...
            if (s.recurringDef) {
                ...
                for (var l = 0, c = be(s, u, t, n.dateEnv, n.pluginSystem.hooks.recurringTypes); l < c.length; l++) {
                    var d = c[l], f = Zt(a, {start: d, end: r.add(d, u)});
                    o[f.instanceId] = f
                }
            }
        }
    ...
    function Pe(e, t) {
        var n = e.instances[t];
        if (n) {
            var r = e.defs[n.defId], i = ze(e, function (e) {
    ...
    function nt(e, t, n) {
        ...
        return 1 === r && "short" === e.timeZoneName ? function (e) {
            ...
            return function (o) {
                var a = o.marker, s = (r && !a.getUTCMinutes() ? r : i).format(a);
    ...
    var lt = function () {
        ...
        return e.prototype.setProp = function (e, t) {
            var n, r;
            if (e in Vt) ; else if (e in Bt) "function" == typeof Bt[e] && (t = Bt[e](t)), this.mutate({standardProps: (n = {}, n[e] = t, n)}); else if (e in xt) {
                var i = void 0;
    ...
    function Rt(e, t, n, r) {
        return void 0 === n && (n = {}), !(e.eventDrag && !function (e, t, n, r) {
            ...
            r && (u = Re(u, r));
            var l = Dt(e.eventStore, i.affectedEvents.instances), c = l.defs, d = l.instances,
            ...
            for (var p in s) {
                ...
                for (var D = t.state.eventStore, T = 0, w = g.allows; T < w.length; T++) {
                    var R = w[T], I = Se({}, n, {range: h.range, allDay: y.allDay}), C = D.defs[y.defId],
                        M = D.instances[p], k = void 0;
    ...
    function Ht(e, t, n) {
        var r = he(e, xt, {}, n), i = function (e, t) {
    ...
    var Bt = {id: String, groupId: String, title: String, url: String, rendering: String, extendedProps: null},
        Vt = {start: null, date: null, end: null, allDay: null}, At = 0;
    ...
    var Gt = {defs: {}, instances: {}}, Xt = function () {
        function e() {
        ...
        return e.prototype.splitProps = function (e) {
            ...
            for (var c in this.eventUiBuilders = Re(n, function (e, n) {
                ...
                var d = n[c], f = a[c] || Gt, p = this.eventUiBuilders[c];
                l[c] = {
    ...
    var dn = 0, fn = function () {
        ...
        return e.addEqualityFuncs = function (e) {
            ...
            }(this.props || {}, e, this.equalityFuncs), n = t.anyChanges, r = t.comboProps;
    ...
    var pn = function (e) {
        ...
        return Ee(t, e), t.prototype.destroy = function () {
            ...
            return !(r && !We(r.validRange, e.range)) && (t = e, n = this.calendar, wt({dateSelection: t}, n))
        ...
        recurringTypes: [{
            parse: function (e, t, n) {
                ...
                return r ? function (e, t, n, r) {
                    var i = e ? Ie(e) : null, o = B(n.start), a = n.end, s = [];
                    for (; o < a;) {
                        var u = void 0;
    ...
    var Tn = vn({
        optionChangeHandlers: {
            events: function (e, t, n) {
                wn([e], t, n)
            }, eventSources: wn, plugins: function (e, t) {
                t.addPluginInputs(e)
            }
        }
    });
    ...
    var xn = function () {
        ...
        return e.prototype.mutate = function (e, t, n) {
            ...
            var e = fe(this.dynamicOverrides.locales, this.overrides.locales, Rn.locales),
                t = fe(this.dynamicOverrides.locale, this.overrides.locale, Rn.locale), n = On(e),
    ...
    var Bn = function () {
            ...
            return e.prototype.createMarker = function (e) {
                ...
                return null !== n ? {unit: "year", value: n} : null !== (n = this.diffWholeMonths(e, t)) ? {
                    unit: "month",
                    value: n
                } : null !== (n = U(e, t)) ? {unit: "week", value: n} : null !== (n = L(e, t)) ? {
                    unit: "day",
                    value: n
                } : ce(n = function (e, t) {
    ...
    function Zn(e, t, n, r) {
        var i = {}, o = he(e, Vn, {}, i), a = {}, s = Ht(i, r, a);
    ...
    function Xn(e, t, n) {
        var r = n.pluginSystem.hooks.eventSourceDefs[e.sourceDefId], i = String(Yn++);
    ...
    function or(e, t, n) {
        var r = function (e, t) {
            var n = {}, r = he(e, ir, {}, n), i = r.start ? t.createMarkerMeta(r.start) : null,
    ...
    function ar(e, t, n) {
        ...
        return {def: r, ui: gt(r, t), instance: Zt(r.defId, e.range), range: e.range, isStart: !0, isEnd: !0}
    }
    ...
    function fr(e, t) {
        var n = lr(e), r = lr(t.overrides.views);
    ...
    var pr = function (e) {
        ...
        return Ee(t, e), t.prototype.destroy = function () {
            ...
            var n = this, o = this.theme, a = this.calendar, u = a.optionsManager, l = a.viewSpecs,
                c = r("div", {className: "fc-" + e}), d = u.computed.customButtons || {},
                f = u.overrides.buttonText || {}, p = u.computed.buttonText || {};
        ...
        return Ee(t, e), t.prototype.destroy = function () {
            ...
            var o = this.opt("header"), a = this.opt("footer"), l = this.calendar.getNow(), c = r.build(l),
    ...
    var mr = {}, Er = function (e) {
        function t(t) {
            var n = e.call(this, t) || this;
            n.handleSegClick = function (e, t) {
                var r = n.component, i = ht(t);
                if (i && r.isValidSegDownEl(e.target)) {
                    var o = p(e.target, ".fc-has-url"), a = o ? o.querySelector("a[href]").href : "";
    ...
    }, br.prototype.baseIconClass = "fc-icon", br.prototype.iconClasses = {
        close: "fc-icon-x",
    ...
    var Dr = function () {
        ...
        return e.prototype.addPluginInputs = function (e) {
            ...
            var t = this.state, n = this.component, r = t.viewType, i = this.viewSpecs[r],
            ...
            var a = this.renderableEventStore = t.eventSourceLoadingLevel && !this.opt("progressiveEventRendering") ? this.renderableEventStore : t.eventStore,
                s = this.buildEventUiSingleBase(i.options), u = this.buildEventUiBySource(t.eventSources),
            ...
            return e.editable && (e = Se({}, e, {eventEditable: !0})), Nt("event", e, this)
            ...
            }(e, t), r = [Er, Sr].concat(this.pluginSystem.hooks.componentInteractions).map(function (e) {
                return new e(n)
            });
            ...
            var n = or(null == t ? null != e.start ? e : {start: e, end: null} : {
                start: e,
                end: t
    ...
    var Mr = function (e) {
        function t(t, n, i, o) {
            var a = e.call(this, t, r("div", {className: "fc-view fc-" + n.type + "-view"}), !0) || this;
        ...
        return Ee(t, e), t.prototype.initialize = function () {
            ...
            this.renderDates(e), this.addScroll({duration: J(this.opt("scrollTime"))}), this.startNowIndicator(e)
    ...
    var kr = function () {
        ...
        return e.prototype.renderSegs = function (e, t) {
            ...
            var t = this.context.view.eventOrderSpecs, n = e.map(Or);
    ...
    function Hr(e) {
        ...
        return e = Se({timeZone: Rn.timeZone, calendarSystem: "gregory"}, e, {locale: t}), new Bn(e)
    }

    var Nr = {startTime: J, duration: J, create: Boolean, sourceId: String}, zr = {create: !0};
    ...
    function Lr(e, t, n, r, i, o, a, s) {
        var u, l = o.view, c = o.dateEnv, d = o.theme, f = o.options, p = Ze(t.activeRange, e),
            h = ["fc-day-header", d.getClass("widgetHeader")];
        return u = "function" == typeof f.columnHeaderHtml ? f.columnHeaderHtml(c.toDate(e)) : "function" == typeof f.columnHeaderText ? Ot(f.columnHeaderText(c.toDate(e))) : Ot(c.format(e, i)), n ? h = h.concat(Qt(e, t, o, !0)) : h.push("fc-" + P[e.getUTCDay()]), '<th class="' + h.join(" ") + '"' + (p && n ? ' data-date="' + c.formatIso(e, {omitTime: !0}) + '"' : "") + (a > 1 ? ' colspan="' + a + '"' : "") + (s ? " " + s : "") + ">" + (p ? Kt(l, {
            date: e,
            forceOff: !n || 1 === r
        }, u) : u) + "</th>"
    }
    ...
    var Br = function (e) {
        ...
        return e.prototype.sliceRange = function (e) {
            ...
            var t = this.indices, n = Math.floor(N(this.dates[0], e));
        ...
        return e.prototype.sliceProps = function (e, t, n, r) {
            ...
            return this._sliceDateSpan.apply(this, [{range: {start: e, end: H(e, 1)}, allDay: !1}, {}, t].concat(n))
    ...
    function Wr(e, t) {
        var n = e.activeRange;
        return t ? n : {start: H(n.start, e.minTime.milliseconds), end: H(n.end, e.maxTime.milliseconds - 864e5)}
    }
    ...
    e.Calendar = Dr, e.Component = fn, e.DateComponent = pn, e.DateEnv = Bn, e.DateProfileGenerator = Jn, e.DayHeader = Br, e.DaySeries = Vr, e.DayTable = Ar, e.ElementDragging = xr, e.ElementScrollController = sn, e.EmitterMixin = tn, e.EventApi = ct, e.FgEventRenderer = kr, e.FillRenderer = _r, e.Interaction = yr, e.Mixin = en, e.NamedTimeZoneImpl = Pr, e.PositionCache = on, e.ScrollComponent = ln, e.ScrollController = an, e.Slicer = Fr, e.Splitter = Xt, e.Theme = cn, e.View = Mr, e.WindowScrollController = un, e.addDays = x, e.addDurations = function (e, t) {
        ...
        re(e), e.forEach(function (t, n) {
            var l = n === e.length - 1 ? i : r, c = t.getBoundingClientRect().height, d = c + C(t);
        ...
        void 0 === t && (t = {});
        var n = Hr(t), r = ot(t), i = n.createMarkerMeta(e);
        ...
        var r = Hr("object" == typeof n && n ? n : {}), i = ot(n, Rn.defaultRangeSeparator), o = r.createMarkerMeta(e),
