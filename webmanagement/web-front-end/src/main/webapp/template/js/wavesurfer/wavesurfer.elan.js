/*!
 * wavesurfer.js 2.1.3 (2019-02-12)
...
function () {
  ...
  _createClass(ElanPlugin, [{
    ...
    value: function render() {
      ...
      indeces.forEach(function (index) {
        ...
        if(tier.id=="Text"){
          th.textContent = "Nội dung nói";
        }else if (tier.id=="Comments"){
          th.textContent = "Người nói";
        }
    ...
    value: function getRenderedAnnotation(time) {
      ...
      this.renderedAlignable.some(function (annotation) {
        //console.log("ID ne: "+annotation.id);
        if (annotation.start <= time && annotation.end >= time) {
          result = annotation;
          //console.log("Tao xem m ra duoc may cai");
  ...
  // console.log("Annotation neeeeeeeeeeeeeè!!!!!");
